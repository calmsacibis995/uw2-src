...
#ident	"@(#)proto:desktop/scripts/globals.sh	1.26"
...
typeset as_PRODUCT_ID=ASE pe_PRODUCT_ID=PED 
typeset ASE_CPU=2 PED_CPU=2 MPU_CPU=1
PROMPTNODE=on
PROMPTKEYB=on
...
typeset -x SerialNumber SerialID ActKey
