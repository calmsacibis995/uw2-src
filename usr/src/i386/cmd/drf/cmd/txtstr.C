...
To exit from this emergency recovery shell, just type 'exit'.
"
DRF_NEXT_FLP="
...
GENERIC_HEADER="UnixWare 2 - Emergency Recovery"
...
you may proceed but will have limited capabilities.
             ...
             Press ENTER to continue."
FS_MOD_LOAD_ERROR="
   An error occurred while loading the file system
modules. Please  check that you have the correct 
