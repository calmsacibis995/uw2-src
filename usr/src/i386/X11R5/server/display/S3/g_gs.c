 ...
 ***
 ***	HISTORY
 ***		$Id: g_gs.c,v 0.10 1993/11/22 06:16:18 koshy Exp koshy $
 ***		$Log: g_gs.c,v $
 ***	Revision 0.10  1993/11/22  06:16:18  koshy
 ***	Revision:0.10
 ***
 ***/
 ...
 */
#if (defined(__DEBUG__))
static boolean generic_graphics_state_debug = FALSE;
#endif
...
generic_graphics_state__initialize__(SIScreenRec *si_screen_p)
{
	...
	flags_p->SIstatecnt = 0;	/* for the chipset specific part to fill in */
