...
#ident	"@(#)S3:S3/s3_regs.c	1.9"

/***
 ***	NAME
 ***
 ***        s3_regs.c : register state for the S3 chipsets.
 ***
 ***	SYNOPSIS
 ***
 ***	DESCRIPTION
...
export const char *const chipset_register_state_kind_to_dump[] = 
{
#define DEFINE_CHIPSET_REGISTER_STATE(NAME) #NAME
	DEFINE_CHIPSET_REGISTER_STATE_KINDS()
#undef DEFINE_CHIPSET_REGISTER_STATE
...
#if (defined(lint))
export int s3_first_mmioable_enhanced_register = 0x8000;
 ...
 * might affect speed.
 */
export int s3_graphics_engine_micro_delay_count = 0;
export int s3_graphics_engine_loop_timeout_count = 0;
export int s3_crtc_sync_loop_timeout_count = 0;
export int s3_dac_access_delay_count = 0;
export int s3_graphics_engine_fifo_blocking_factor = 0;
export int s3_graphics_engine_number_of_fifo_entries_free = 0;
...
#if (defined(__DEBUG__))
export boolean s3_register_debug = FALSE;
#endif
