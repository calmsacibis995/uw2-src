...
#pragma ident	"@(#)mach64:mach64/g_state.c	1.2"
...
#if (defined(__DEBUG__))
export boolean generic_state_debug = 0;
#endif
...
generic_screen_state__initialize__(SIScreenRec *si_screen_p)
{
	...
	/*
	 * BUGALLERT:
	 * For depths that are not a power of 2 this field will 
	 * have invalid value.
	 */
	if (!(config_p->depth & (config_p->depth - 1)))
	{
