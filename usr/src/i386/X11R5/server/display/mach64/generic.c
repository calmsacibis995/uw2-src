...
#pragma ident	"@(#)mach64:mach64/generic.c	1.2"
...
export boolean generic_debug = 0;
#endif
    ...
    struct generic_screen_state *screen_state_p)
{
	...
	if (generic_debug)
	{
		(void) fprintf(debug_stream_p, 
			...
			(void *) si_screen_p, (void *) screen_state_p);
	}
#endif /* __DEBUG__ */	
	...
	{
		(void) fprintf(stderr, GENERIC_MESSAGE_ENABLING_COMPATIBILITY_MODE);
