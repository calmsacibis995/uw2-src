...
#pragma ident	"@(#)vga256:vga256/devices/etw32p/cursor.h	1.2"
...
/*
 *  etw32p_curs_region:  base of cursor storage in off-screen video RAM;
 *  address is board-relative.
 *  NOTE:  etw32p_curs_region should be set up  beforehand such that
 *  no cursor's data overlaps a video page boundary.
 */
extern int etw32p_curs_region;


extern SIBool etw32p_curs_download();
extern SIBool etw32p_curs_turnon();
extern SIBool etw32p_curs_turnoff();
extern SIBool etw32p_curs_move();
extern SIBool etw32p_curs_restore();
