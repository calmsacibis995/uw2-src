...
#ident	"@(#)kern:net/loopback/ticlts.h	1.12"
#ident	"$Header: $"
...
/* basic constant - not ifdef KERNEL for ABI */
 ...
 */
struct tcl_endpt {
	lock_t		    *te_lock;	/* lock to protect this structure */
	event_t		    *te_event;	/* event */
	int		     te_bid;	/* bufcall id */
	struct tcl_endpt    *te_linkep;	/* linked endpt for M_PASSFP */
