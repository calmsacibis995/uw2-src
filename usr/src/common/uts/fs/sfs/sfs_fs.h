...
#ident	"@(#)kern:fs/sfs/sfs_fs.h	1.11"
#ident	"$Header: $"
 ...
 * information in the inode, using the ``blksize(fs, size, lbn)'' macro.
 *
...
#ifndef MAXFRAG
#define MAXFRAG		8	/* maximum frags */
#endif
...
#define blkrounddown(fs, size)    (size & (fs)->fs_bmask)
...
#define getfs(vfsp) ((struct fs *)((struct sfs_vfs *)vfsp->vfs_data)->vfs_bufp->b_addrp)
