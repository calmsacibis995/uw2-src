 ...
 * 
 */
#ident	"@(#)langsup:common/ls/Xim/lslib/ol/OlUnsetIcF.c	1.2"
#include <stdlib.h>
#include <string.h>
#include <X11/Xlib.h>
...
/*
 * OlUnsetIcFocus()   : Unset Focus of OL Input Context.
 *                  In: Pointer to the OL Input Context.
 *                 Out: Nothing.
 *              Return: Nothing.
 *              Errors: None.
 *           Algorithm: Check arguments, then call XIM.
 */

void
OlUnsetIcFocus(ol_ic_p)
    OlIc	*ol_ic_p;
{
    ...
    XUnsetICFocus((XIC) ol_ic_p->ictype);
}
