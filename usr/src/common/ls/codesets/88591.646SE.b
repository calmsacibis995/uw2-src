...
#ident	"@(#)langsup:common/ls/codesets/88591.646SE.b	1.1"

# 1989/01 AT&T-UEL
# From codeset: ISO 8859-1
# To codeset:	Swedish 646 ascii variant - ISO 646 SE
# Based on:	88591.646.b
# Notes:	"best fit"

map full (88591.646SE.b) {
	...
	string(\274 '_')	# vulgar fraction one quarter
	string(\275 '_')	# vulgar fraction one half
	string(\276 '_')	# vulgar fraction three quarters
