...
#ident	"@(#)langsup:common/ls/codesets/asc.88591.p	1.1"

# 1989/01 AT&T-UEL
# From codeset:	8-bit ascii - (PC codeset)
# To codeset:	ISO 8859-1
# Derived from:	asc.88591.d
# Notes:	"Print" is the same but franc sign = 'f', alpha ='a'

map full (asc.88591.p) {
