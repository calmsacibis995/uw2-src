...
/* ----------------------------------------------------------------------
	...
	DO NOT CHANGE THIS LINE. IT CONTAINS A ^A so STAR
	TREATS IT AS A BINARY FILE. IT CONTAINS %?% WHICH
	GET EXPANDED BY SCCS. 
...
date "+by $LOGNAME%nmonth %m%nday %d%nhour %H%nminute %M" >/usr/tmp/data$$
