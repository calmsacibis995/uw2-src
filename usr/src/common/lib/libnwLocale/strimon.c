...
#ident	"@(#)libNwLocale:strimon.c	1.1"
#ident "$Header: /SRCS/esmp/usr/src/nw/lib/libnwLocale/strimon.c,v 1.1 1994/09/26 17:21:21 rebekah Exp $"
/*--------------------------------------------------------------------------
...
*/
   ...
   if (tmp.sign)   /* negative number */
   {
      ...
      {
         NWLstrrev(ptr, __lconvInfo.int_curr_symbol);
         ptr += _fstrlen(__lconvInfo.int_curr_symbol);
         *ptr++ = ' ';
      }
   }
   else
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwLocale/strimon.c,v 1.1 1994/09/26 17:21:21 rebekah Exp $
*/
