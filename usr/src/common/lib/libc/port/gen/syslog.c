...
#ident	"@(#)libc-port:gen/syslog.c	1.17"
...
#ifdef DSHLIB	/* needed for _abi_*log* functions.
		 * user visible syslog moved to libgen
		 * functions: _abi_syslog, _abi_vsyslog, _abi_openlog,
		 *	      _abi_closelog, _abi_setlogmask
                 */
#include "synonyms.h"
#include <sys/types.h>
#include <stropts.h>
