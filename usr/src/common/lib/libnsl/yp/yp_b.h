...
#ident	"@(#)libnsl:common/lib/libnsl/yp/yp_b.h	1.2.7.2"
#ident  "$Header: $"
...
struct dom_binding {
	...
	CLIENT *dom_client;
#ifdef _REENTRANT
	mutex_t _yp_domain_entry_lock;	/* protects the client handle */
#endif
};
...
typedef struct ypbind_resp ypbind_resp_t;
...
extern ypbind_resp_t *ypbindproc_domain_3();
