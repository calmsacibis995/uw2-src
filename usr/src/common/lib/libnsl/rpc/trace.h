...
#ident	"@(#)libnsl:common/lib/libnsl/rpc/trace.h	1.1.2.2"
#ident	"$Header: $"
...
/*
 * XXX: Added later by USL
 */
#define TR___get_rpc_hostent_private 872
#define TR___rpcdata 873
#define TR_xdr_cryptkeyarg2 874
#define TR_sethostfile 875
#define TR_rpcb_findaddr 876
...
#define	trace(ev, d0, d1, d2, d3, d4, d5) \
    _rpc_trace((ev), (u_long)(d0), (u_long)(d1), (u_long)(d2), \
