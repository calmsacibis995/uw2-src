...
#ident	"@(#)libsnmp:auth_lib.c	1.4"
#ident	"$Header: /SRCS/esmp/usr/src/nw/lib/libsnmp/auth_lib.c,v 1.3.2.1 1994/10/25 17:41:40 cyang Exp $"
/****************************************************************************
 *                                                                          *
...
#ifndef lint
static char TCPID[] = "@(#)auth_lib.c	1.1 STREAMWare TCP/IP SVR4.2 source";
#endif /* lint */
/*      SCCS IDENTIFICATION        */
/*
