...
/*manpage*NWNCP88s15ResetAuditHistFile**********************************
...
NCP:     88 15  Reset Audit History File
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/88s15.c,v 1.7 1994/09/26 17:39:54 rebekah Exp $
*/
