...
)
{
   ...
   *(pnuint32)&cur[0] = (nuint32)0;
   ...
   return NWCFragmentRequest(pNetAccess, (nuint)2, (nuint32)54, (nuint)2,
            reqFrag, (nuint)0, NULL, NULL);
}

/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/d54v0.c,v 1.7 1994/09/26 17:41:09 rebekah Exp $
*/
