...
/*manpage*NWNCP23s126SetQCurrStatus*****************************************
...
REMARKS: This is a new NetWare 386 v3.11 call that replaces the earlier call Set
         Queue Current Status (0x2222  23  103).  This new NCP allows the use of the
...
SEE:     23 103  Set Queue Current Status
...
)
{
   ...
   #define NCP_SUBFUNCTION ((nuint8) 126)
   ...
   NCopyLoHi32((pnuint32)&abuReq[7], &luQueueStatus);
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/23s126.c,v 1.7 1994/09/26 17:35:24 rebekah Exp $
*/
