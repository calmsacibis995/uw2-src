...
/*manpage*NWNCP23s223GetLogicalRecsByConn*********************************
...
SEE:     23 239  Get Logical Records By Connection (3.x)
...
)
{
   ...
   #define NCP_SUBFUNCTION    ((nuint8)        223)
   #define NCP_STRUCT_LEN     ((nuint16)         5)
   #define NCP_REQ_LEN        ((nuint)           7)
   #define NCP_REP_LEN        ((nuint)           3)
   ...
   if(lCode == 0)
   {
      NCopyHiLo16(psuIterHnd,&abuRep[0]);
      *pbuNumRecs = abuRep[2];
   }
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/23s223.c,v 1.7 1994/09/26 17:36:29 rebekah Exp $
*/
