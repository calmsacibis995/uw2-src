...
/*manpage*NWNCP88s19GetAuditFlags**********************************
...
)
{
   ...
   return NWCRequestSingle(pAccess, NCP_FUNCTION, abuReq, REQ_LEN,
               pbuAuditFlags, REPLY_LEN, NULL);
}

/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/88s19.c,v 1.7 1994/09/26 17:39:58 rebekah Exp $
*/
