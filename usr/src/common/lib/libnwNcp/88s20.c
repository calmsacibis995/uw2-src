...
/*manpage*NWNCP88s20CloseOldAuditFile**********************************
...
NCP:     88 20  Close Old Audit File
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/88s20.c,v 1.7 1994/09/26 17:40:01 rebekah Exp $
*/
