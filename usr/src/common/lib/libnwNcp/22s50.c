...
/*manpage*NWNCP22s50GetObjEffectRights****************************************
...
)
{
   ...
   replyFrag[0].pAddr = psuAccessRights;
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/22s50.c,v 1.7 1994/09/26 17:34:37 rebekah Exp $
*/
