...
/*manpage*NWNCP88s8EnableVolAuditing**********************************
...
NCP:     88 08  Enable Auditing on a Volume
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/88s8.c,v 1.7 1994/09/26 17:40:10 rebekah Exp $
*/
