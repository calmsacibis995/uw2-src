...
/*manpage*NWNCP88s2AddUserAuditProp**********************************
...
NCP:     88 02  Add User Audit Property
...
/*
$Header: /SRCS/esmp/usr/src/nw/lib/libnwNcp/88s2.c,v 1.7 1994/09/26 17:40:00 rebekah Exp $
*/
