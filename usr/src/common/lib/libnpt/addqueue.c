...
#ident	"@(#)libnpt:addqueue.c	1.2"
static char sccsid[] = "@(#)$Header: /SRCS/esmp/usr/src/nw/lib/libnpt/addqueue.c,v 1.1 1994/02/11 23:05:04 eric Exp $";
#endif
 ...
 *
 * Description:	This file contains routines to manipulate
 *				print queues used by a printer
 *
...
uint16
PSAddQueueToPrinter(connectID, printerNumber, fserverName,
	queueName, priority)
