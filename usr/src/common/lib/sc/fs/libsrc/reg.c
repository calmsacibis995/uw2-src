...
{
	if (usenumber >= 0 && defsize != usesize * usenumber)
	{
		if (usenumber == 1)
		{
...
//		if (dp->watched || dwatch || verbose)
		{
			...
			fprintf(stderr, "object #%d were not compiled with -f), or you really did\n", dp->onum);
...
extern void fs_help()
{
	...
	fprintf(stderr, "fs_dbxinit() - print a .dbxinit file which incorporates freestore's functions\n");
	fprintf(stderr, "              into Sun's dbxtool(1) button panel\n");
	fprintf(stderr, "fs_debugrc() - print a .debugrc file which incorporates freestore's functions\n");
	fprintf(stderr, "              into UnixWare's debug(1)\n");
	...
	fprintf(stderr, "is initialized but the line containing the call to new was not compiled with -f.\n");
	fprintf(stderr, "\n");
}
...
extern void fs_debugrc()
{
	// fs_showall() is aliased by the short "fs", everything else is
	// called by its full name to avoid polluting debugger name space
	fprintf(stderr, "alias fs set fs_showall()\n");
	fprintf(stderr, "alias fs_showall set fs_showall()\n");
	fprintf(stderr, "alias fs_mark set fs_mark()\n");
	fprintf(stderr, "alias fs_unmark set fs_unmark()\n");
	fprintf(stderr, "alias fs_since set fs_since()\n");
	fprintf(stderr, "alias fs_sincen set fs_sincen($1)\n");
	fprintf(stderr, "alias fs_watch set fs_watch($1)\n");
	fprintf(stderr, "alias fs_unwatch set fs_unwatch($1)\n");
	fprintf(stderr, "alias fs_watchall_d set fs_watchall_d()\n");
	fprintf(stderr, "alias fs_unwatchall_d set fs_unwatchall_d()\n");
	fprintf(stderr, "alias fs_watchall_n set fs_watchall_n()\n");
	fprintf(stderr, "alias fs_unwatchall_n set fs_unwatchall_n()\n");
	fprintf(stderr, "alias fs_break stop fs_break\n");
	fprintf(stderr, "alias fs_status set fs_status()\n");
	fprintf(stderr, "alias fs_dbxinit set fs_dbxinit()\n");
	fprintf(stderr, "alias fs_debugrc set fs_debugrc()\n");
	fprintf(stderr, "alias fs_help set fs_help()\n");
}
