...
/*ident       "@(#)sc:Fsm/demos/candy.c	3.2" */
/******************************************************************************
*
...
main(){
    ...
    v.trans(zero,(unsigned int)nickle,five,click);
    v.trans(zero,dime,ten,clickclick);
    v.trans(five,(unsigned int)nickle,ten,click);
    v.trans(five,dime,fifteen,clickclick);
    v.trans(ten,(unsigned int)nickle,fifteen,click);
    v.trans(ten,dime,twenty,clickclick);
    v.trans(fifteen,(unsigned int)nickle,twenty,click);
