...
/*ident	"@(#)sc:Graph/incl/Graph.h	3.3"	*/
/******************************************************************************
*
...
#include <generic.h>
#define PSETF_ATTLC_P(X) name2(X,_PSETF_ATTLC)
#define PSETFG_ATTLC_P(X) name2(X,_PSETFG_ATTLC)


#define graphtypedefs_ATTLCdeclare(G,V,E) \
 \
typedef Set_of_p<G> (Vertex::* PSETF_ATTLC_P(G) )() const; \
typedef Set_of_p<E> (Vertex::* PSETF_ATTLC_P(E) )() const; \
typedef Set_of_p<E> (Vertex::* PSETFG_ATTLC_P(E) )(const Graph&) const; \
 \
...
extern const PSETF_ATTLC_P(Graph)	Vertex_graphs_ATTLC;
extern const PSETF_ATTLC_P(Edge)	Vertex_edges_ATTLC;
extern const PSETFG_ATTLC_P(Edge)	Vertex_edges_g_ATTLC;
extern const PSETF_ATTLC_P(Edge)	Vertex_in_edges_ATTLC;
extern const PSETFG_ATTLC_P(Edge)	Vertex_in_edges_g_ATTLC;
extern const PSETF_ATTLC_P(Edge)	Vertex_out_edges_ATTLC;
extern const PSETFG_ATTLC_P(Edge)	Vertex_out_edges_g_ATTLC;
extern const PSETF_ATTLC_P(Edge)	Vertex_loop_edges_ATTLC;
extern const PSETFG_ATTLC_P(Edge)	Vertex_loop_edges_g_ATTLC;
...
inline Set_of_p<G>	V::graphs() const { \
		    return (this->*((PSETF_ATTLC_P(G))Vertex_graphs_ATTLC))(); \
		} \
inline Set_of_p<E>	V::edges() const { \
		    return (this->*((PSETF_ATTLC_P(E))Vertex_edges_ATTLC))(); \
		} \
inline Set_of_p<E>	V::edges_g(const G& g) const { \
		    return (this->*((PSETFG_ATTLC_P(E))Vertex_edges_g_ATTLC))(g); \
		} \
inline Set_of_p<E>	V::in_edges() const { \
		    return (this->*((PSETF_ATTLC_P(E))Vertex_in_edges_ATTLC))(); \
		} \
inline Set_of_p<E>	V::in_edges_g(const G& g) const { \
		    return (this->*((PSETFG_ATTLC_P(E))Vertex_in_edges_g_ATTLC))(g); \
		} \
inline Set_of_p<E>	V::out_edges() const { \
		    return (this->*((PSETF_ATTLC_P(E))Vertex_out_edges_ATTLC))(); \
		} \
inline Set_of_p<E>	V::out_edges_g(const G& g) const { \
		    return (this->*((PSETFG_ATTLC_P(E))Vertex_out_edges_g_ATTLC))(g); \
		} \
inline Set_of_p<E>	V::loop_edges() const { \
		    return (this->*((PSETF_ATTLC_P(E))Vertex_loop_edges_ATTLC))(); \
		} \
inline Set_of_p<E>	V::loop_edges_g(const G& g) const { \
		    return (this->*((PSETFG_ATTLC_P(E))Vertex_loop_edges_g_ATTLC))(g); \
		} \
 \
