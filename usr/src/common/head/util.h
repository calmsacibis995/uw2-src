...
#ident	"@(#)head-nuc:util.h	1.2"
#ident "$Header: /SRCS/esmp/usr/src/nw/head/util.h,v 1.1.1.1 1993/10/11 20:27:50 ram Exp $"
...
extern void tli_error(char *msg , int dir, int flags);
