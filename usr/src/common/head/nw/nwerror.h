...
#ident	"@(#)head-nuc:nw/nwerror.h	1.5"
/*--------------------------------------------------------------------------
...
#define ERR_TARGET_NOT_A_SUBDIRECTORY   0x8986  /* 150 can be changed later (note written by server people). */
...
#define NWE_DIR_TARGET_INVALID          0x8986  /* 150 */
...
/*
$Header: /SRCS/esmp/usr/src/nw/head/nw/nwerror.h,v 1.7 1994/09/26 17:12:09 rebekah Exp $
*/
