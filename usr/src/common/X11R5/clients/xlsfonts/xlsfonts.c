...
#ident	"@(#)r5xlsfonts:xlsfonts.c	1.3"
/*
...
#define DISCLAIMER "Response time for the \"-l\" option is extremely slow;\n"
#define  CHOICE "If you wish to continue with \"-l\" press (y) otherwise, press any key: " 
