    ...
    Position     x, y;
{
    ...
    points[0].y = InWindowY(BW, y + (int)1.0/2);
    points[1].x = InWindowX(BW, x + (int)1.0/2);
    points[1].y = InWindowY(BW, y + 1);
    points[2].x = InWindowX(BW, x + 1);
    points[2].y = InWindowY(BW, y + (int)1.0/2);
    points[3].x = InWindowX(BW, x + (int)1.0/2);
    points[3].y = InWindowY(BW, y);
    points[4].x = InWindowX(BW, x);
    points[4].y = InWindowY(BW, y + (int)1.0/2);
    ...
    Widget w;
{
    ...
    XDrawLine(XtDisplay(BW), XtWindow(BW),
	      BW->bitmap.axes_gc,
	      InWindowX(BW, 0),
	      InWindowY(BW, (int) ( (float)BW->bitmap.height / 2.0)),
	      InWindowX(BW, BW->bitmap.width),
	      InWindowY(BW, (int) ((float)BW->bitmap.height / 2.0)));
    XDrawLine(XtDisplay(BW), XtWindow(BW),
	      BW->bitmap.axes_gc,
	      InWindowX(BW, (int) ((float)BW->bitmap.width / 2.0)),
	      InWindowY(BW, 0),
	      InWindowX(BW, (int) ((float)BW->bitmap.width / 2.0)),
	      InWindowY(BW, BW->bitmap.height));
}
