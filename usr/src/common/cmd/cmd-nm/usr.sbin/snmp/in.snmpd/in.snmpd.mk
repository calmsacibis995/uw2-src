...
#ident	"@(#)cmd-nm:common/cmd/cmd-nm/usr.sbin/snmp/in.snmpd/in.snmpd.mk	1.8"
#ident	"$Header: /SRCS/esmp/usr/src/nw/cmd/cmd-nm/usr.sbin/snmp/in.snmpd/in.snmpd.mk,v 1.11 1994/10/07 20:28:55 cyang Exp $"
...
#      @(#)snmpd.mk	2.2 INTERACTIVE SNMP  source
...
LOCALDEF=-DSVR4 -DSTRNET -D_KMEMUSER -DNETWARE
...
in.snmpd: ${OBJS} ${LIBS}
	${CC} -o in.snmpd ${LDFLAGS} ${OBJS} ${LIBS} ${LDLIBS} ${SHLIBS} 
