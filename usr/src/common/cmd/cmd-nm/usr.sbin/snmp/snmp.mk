...
#ident	"@(#)cmd-nm:common/cmd/cmd-nm/usr.sbin/snmp/snmp.mk	1.3"
#ident "$Header: /SRCS/esmp/usr/src/nw/cmd/cmd-nm/usr.sbin/snmp/snmp.mk,v 1.3 1994/05/24 19:50:54 cyang Exp $"
