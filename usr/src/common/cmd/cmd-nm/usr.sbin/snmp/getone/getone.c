...
#ident	"@(#)cmd-nm:common/cmd/cmd-nm/usr.sbin/snmp/getone/getone.c	1.8"
#ident	"$Header: /SRCS/esmp/usr/src/nw/cmd/cmd-nm/usr.sbin/snmp/getone/getone.c,v 1.13 1994/09/23 16:38:05 cyang Exp $"
#ifndef lint
...
int main(int argc, char *argv[])
{
  ...
  if(((argc - optind) < 3) || (errflg == 1))
    {
      fprintf(stderr, gettxt(":1", "Usage: %s [-T timeout] entity_addr community_string object_name...\n"), argv[0]);
      exit(-1);
    }
