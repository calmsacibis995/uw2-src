...
#ident	"@(#)cmd-nm:common/cmd/cmd-nm/usr.sbin/snmp/getid/getid.c	1.7"
#ident	"$Header: /SRCS/esmp/usr/src/nw/cmd/cmd-nm/usr.sbin/snmp/getid/getid.c,v 1.9 1994/08/09 23:34:37 cyang Exp $"
#ifndef lint
