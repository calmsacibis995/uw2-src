...
#ident	"@(#)cmd-nm:common/cmd/cmd-nm/usr.sbin/snmp/mosy/asp.c	1.2"
#ident	"$Header: /SRCS/esmp/usr/src/nw/cmd/cmd-nm/usr.sbin/snmp/mosy/asp.c,v 1.2 1994/05/24 19:42:22 cyang Exp $"
#ifndef lint
