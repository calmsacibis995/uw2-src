...
#ident	"@(#)cmd-nm:common/cmd/cmd-nm/usr.sbin/snmp/mosy/post_mosy.c	1.2"
#ident	"$Header: /SRCS/esmp/usr/src/nw/cmd/cmd-nm/usr.sbin/snmp/mosy/post_mosy.c,v 1.2 1994/05/24 19:42:25 cyang Exp $"
#ifndef lint
