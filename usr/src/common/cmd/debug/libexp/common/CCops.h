 ...
 * hereby transferred.
 */
#ident	"@(#)debugger:libexp/common/CCops.h	1.6"

// Operators for C and C++

// The caller must define the macro "OP_ENTRY(enum, string, operator, val)"
...
OP_ENTRY( N_DT_MPTR,	"DT_MPTR",	"::*",		234 )
