...
#ident	"@(#)oampkg:common/cmd/oampkg/pkginstall/predepend.c	1.3.6.4"
...
#define ERR_RMLINK	":421:unable to remove options file <%s>"
#define ERR_SYMLINK	":422:unable to create symbolic link from <%s> to <%s>"
#define ERR_PREDEPEND	":423:unable to create predepend file <%s>"
