...
#ident	"@(#)oampkg:common/cmd/oampkg/pkginstall/cppath.c	1.7.8.6"
#ident  "$Header: $"
#include <stdio.h>
#include <limits.h>
#include <string.h>
...
#define MSG_IMPDIR	":321:%s <implied directory>"
#define WRN_RENAME	":322:WARNING:unable to rename <%s>"
#define MSG_RENAME	":323:- file left in indeterminate state"
#define MSG_OLDFILE	":324:- old file restored"
#define	ERR_NOSPACE	":325:- no space left on device"
#define ERR_ULIMIT	":326:- file exceeds package ulimit"
#define ERR_STAT	":327:unable to stat <%s>"
#define MSG_PROCMV	":328:- executing process moved to <%s>"
#define ERR_READ	":329:unable to open <%s> for reading"
#define ERR_WRITE	":68:unable to open <%s> for writing"
#define ERR_OUTPUT	":330:error while writing file <%s>"
#define ERR_UNLINK	":331:unable to unlink <%s>"
#define ERR_LOG		":332:unable to open logfile <%s>"
#define ERR_UTIME	":333:unable to reset access/modification time of <%s>"
