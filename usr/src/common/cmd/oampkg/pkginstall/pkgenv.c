...
#ident	"@(#)oampkg:common/cmd/oampkg/pkginstall/pkgenv.c	1.1.6.4"
#ident  "$Header: $"
...
#define ERR_NOPARAM	":416:%s parameter is not defined in <%s>"
#define ERR_PKGINFO	":384:unable to open pkginfo file <%s>"
#define ERR_PKGMAP	":125:unable to open pkgmap file <%s>"
#define ERR_PKGBAD	":417:PKG parameter is invalid <%s>"
