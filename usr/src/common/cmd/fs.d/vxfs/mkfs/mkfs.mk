...
# @(#)usr/src/common/cmd/fs.d/vxfs/mkfs/mkfs.mk	2.10 11 Oct 1994 11:47:44 - Copyright (c) 1994 VERITAS Software Corp.
#ident	"@(#)vxfs.cmds:common/cmd/fs.d/vxfs/mkfs/mkfs.mk	1.5.1.10"
...
mkfs: mkfs.o $(LIBDIR)/libvxfsi.a
	$(CC) $(LDFLAGS) -o $@ mkfs.o $(LIBDIR)/libvxfsi.a $(LDLIBS) $(ROOTLIBS)

mkfs.dy: mkfs.o $(LIBDIR)/libvxfsi.a
	$(CC) $(LDFLAGS) -o $@ mkfs.o $(LIBDIR)/libvxfsi.a $(LDLIBS) $(SHLIBS)
