...
# @(#)usr/src/common/cmd/fs.d/vxfs/fsdb/fsdb.mk	2.8 11 Oct 1994 11:47:39 - Copyright (c) 1994 VERITAS Software Corp.
#ident	"@(#)vxfs.cmds:common/cmd/fs.d/vxfs/fsdb/fsdb.mk	1.7.1.9"
...
fsdb: fsdb.o
	$(CC) $(LDFLAGS) -o $@ $@.o $(NOSHLIBS) $(LDLIBS)
