...
#ident	"@(#)mail:common/cmd/mail/re/lre.h	1.1.2.4"
...
#ident "@(#)lre.h	1.4 'attmail mail(1) command'"
#ifndef	LRE_H
#define LRE_H
...
extern void egbr(re_re*, int);
extern int egdfabr(re_re*, unsigned char*, unsigned char*, unsigned char**, unsigned char**);
extern int eg_match(re_re*, unsigned char*, unsigned char*, unsigned char**, unsigned char**, int);
