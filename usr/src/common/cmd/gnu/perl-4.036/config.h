...
#ident	"@(#)gnu.cmd:perl-4.036/config.h	1.1"
#ifndef config_h
#define config_h
/* config.h
 ...
 */
#define CPPSTDIN "/export/ESMP/xenv/q2/usr/ccs/bin/i386cc -E"
#define CPPMINUS "-"
 ...
 */
#define SCRIPTDIR "/tmp/perl"             /**/

/* SIG_NAME
 *	This symbol contains an list of signal names in order.
 */
#define SIG_NAME "ZERO","HUP","INT","QUIT","ILL","TRAP","ABRT","EMT","FPE","KILL","BUS","SEGV","SYS","PIPE","ALRM","TERM","USR1","USR2","CHLD","PWR","WINCH","URG","IO","STOP","TSTP","CONT","TTIN","TTOU","VTALRM","PROF","XCPU","XFSZ","WAITING","LWP","AIO"		/**/
