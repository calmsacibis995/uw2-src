...
#ident	"@(#)ttymon:common/cmd/ttymon/ttymon.notp/ttymon.h	1.4"
...
/*	for this 4.0 in 4.2 ttymon, we just store the values */
/*	to really use we would put 'struct sak' in pmtab and use */
/*	the 4.2 tmutil stuff to read in sak */
#define         P_SAKTYPE       16
#define         P_SAKDEF        17
#define         P_SAKSEC        18
