...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.lib/libsnmp/prse_pkt.c	1.1"
#ident	"$Header: $"
...
VarBindList *
parse_varbind(working_ptr, end_ptr)
...
short
parse_null(working_ptr, end_ptr, type)
	unsigned char **working_ptr;
	unsigned char *end_ptr;
	short *type;
{
...
long
parse_sequence(working_ptr, end_ptr, type)
	unsigned char **working_ptr;
	unsigned char *end_ptr;
	short *type;
{
...
short
parse_type(working_ptr, end_ptr)
	unsigned char **working_ptr;
	unsigned char *end_ptr;
{
	short type;
...
long
parse_length(working_ptr, end_ptr)
	unsigned char **working_ptr;
	unsigned char *end_ptr;
{
	long length;
