...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.sbin/ntp/xntpdc/ntpdc_ops.c	1.2"
#ident	"$Header: $"
...
void reslist(), restrict(), unrestrict(), delrestrict();
void monlist(), monitor();
void reset(), preset();
...
struct clktype {
	...
	{ REFCLK_WWV_PST,	"Precision Standard Time WWV clock (3)" },
