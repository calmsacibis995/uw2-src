...
ON5 "%1 : %2 : accŠs refus‚ ou fichier introuvable\n"

$ this is the first part of an error message, %1 is the program name
ON6 "%1: "

$ %1 is the program name
ON7 "%1 : aucun processus … distance dans la table des tƒches."
...
ON29 "Syntaxe : %1 [-signal] %idtƒche\n"

$ %1 is the name of the program
ON30 "%1 : table des tƒches satur‚e\n"
...
PCIINIT_NETWARE_DRIVES "La premiŠre unit‚ NetWare est %1\n"
...
PCIINIT12 "la version du pont doit ˆtre sup‚rieure … 2.7.2\n"
...
PCIINIT16 "Version %1.%2.%3 (s‚rie nø%4.%5) initialis‚e\n"
...
PCIINIT30 "initialisation impossible aprŠs l'initialisation de NetWare\n"
...
JOBS_MSG " entr‚es de la table des tƒches\r\n\n$"
...
PRINTER11 "Impossible de d‚finir les paramŠtres d'impression [LPT%1]\n"
...
\                /m      Autoriser les traductions en plusieurs caractŠres.\n\
\                /a      Abandonner la traduction en cas d'‚chec.\n\
\                /s      Utiliser la meilleure conversion possible en un caractŠre unique.\n\
