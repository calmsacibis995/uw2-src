...
#
usage(){
echo "Syntaxe : ${CMD_NAME} regular (menus définis en couleurs STANDARD)"
echo "     ou : ${CMD_NAME} warn    (menus définis en couleurs AVERTISSEMENT)"
echo "     ou : ${CMD_NAME} error    (menus définis en couleurs ERREUR)"
return 1
}
