...
#
usage(){
echo "Uso: ${CMD_NAME} regular (imposta i colori dei menu sui colori di schermo REGULAR)"
echo "   o: ${CMD_NAME} warn      (imposta i colori dei menu sui colori di schermo WARNING)"
echo "   o: ${CMD_NAME} error     (imposta i colori dei menu sui colori di schermo ERROR)"
return 1
}
