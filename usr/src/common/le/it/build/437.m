...
$	-	dosexec
BAD_IMG "BAD_IMG: %1: ERRORE: Il file immagine '%2' non ä del tipo previsto.\n"
$	-	crt
$	-	tkbd
BAD_LCS_SET_TBL "BAD_LCS_SET_TBL: %1: ERRORE: Tabella codici non valida.\n\
\   Impossibile usare la tabella %2 o %3. errno=%4."
$	-	dosopt
BAD_OPT_USAGE "BAD_OPT_USAGE: %1: ERRORE: L'opzione '%2' non ä usata correttamente.\n"
$	-	dosexec
BAD_SWD "BAD_SWD: %1: ERRORE: Errore di comunicazione UNIX-DOS.\n"
$	-	dosexec
BOPT_ERR "BOPT_ERR: %1: ERRORE: 'dos +b' non ä ammesso.\n"
$	-	dosexec
CD_X "CD_X: %1: ERRORE: 'cd' iniziale sull'unitÖ %2 non riuscito.\n\
...
$	-	dosexec
CWD_TOOLONG "CWD_TOOLONG: %1: ERRORE: La directory di lavoro attuale ä troppo lunga %2.\
\nMax=%3.\n"
$	-	dosexec
DA_FAIL "DA_FAIL: Impossibile collegare direttamente '%2'. Errore con dispositivo '%3'.\n"
$	-	dosexec
DEV_NA "DEV_NA: %1: ERRORE: Il dispositivo richiesto %2 non ä disponibile.\n"
$	-	dosexec
...
DINFO_RAM "RAM"
DINFO_EMS "EMS"
DINFO_FDRIVES "UnitÖ a dischetti:"
DINFO_HERC "HERC"
DINFO_LPT "LPT"
DINFO_MONO "MONO"
DINFO_MOUSE "Mouse"
...
\    Se nome_dispositivo non ä specificato, il default ä l'output standard.\n"
$	-	dosexec
...
come due lettere di unitÖ, %2 e %3, con accesso WRITE. Ciï non ä permesso.\n\
Continuo con l'accesso READ-ONLY a queste unitÖ.\n"
$	-	dosexec
...
$	-	dosexec
DRIVE_LETTER "DRIVE_LETTER: %1: ERRORE: Lettera di unitÖ %2 non ammessa\n"
$	-	dosexec
...
\  non ä definita.\n"
$	-	dosexec
ENV_TOOMUCH "ENV_TOOMUCH: %1: ERRORE: L'ambiente ä troppo lungo %2. max=%3.\n"
$	-	crt
...
$	-	dosexec
IA_FAIL "IA_FAIL: '%2' non ä disponibile.\n\
Il dispositivo '%3' ä in uso o ha un permesso non corretto.\n"
$	-	dosexec
$	-	dosopt
ILL_DRV "ILL_DRV: %1: ERRORE: UnitÖ '%2' non ammessa.\n"
$	-	dosexec
$	-	dosopt
...
$	-	dosexec
INVALID_DEV "INVALID_DEV: %1: ERRORE: %2 non ä un dispositivo valido. (%3)\n"
$	-	dosexec
INVALID_TMM "INVALID_TMM: %1: ERRORE: %2 non ä un dispositivo valido.\n\
...
$	-	dosexec
MAX_USER "Impossibile avviare un'altra sessione DOS/Windows, perchÇ il\n\
...
$	-	dosexec
MERGE_NA "MERGE_NA: %1: ERRORE: Merge non ä configurato nel sistema.\n\
...
$	-	dosexec
NO_DOS "NO_DOS: %1: ERRORE: DOS non ä installato.\n\
\  Eseguire 'dosinstall' per installare il DOS prima di usare Merge.\n"
$	-	dosexec
NO_PATH "NO_PATH: %1: ERRORE: Il PERCORSO UNIX non ä stato impostato.\n"
$	-	dosexec
...
Ora non ä consentito l'uso di DOS/Windows.\n"
$	-	dosexec
$	-	crt
$	-	tkbd
$	-	dosexec
NOT_DEV "NOT_DEV: %1: ERRORE: %2 (%3) non ä un dispositivo.\n"
$	-	dosexec
$	-	dosopt
NOT_DOS_PROG "NOT_DOS_PROG: %1: ERRORE: '%2' non ä un programma DOS.\n"
$	-	dosopt
NOT_RW_ERR "NOT_RW_ERR: %1: ERRORE: Impossibile aprire il file '%2'.\n\
\  Il file non esiste o non si ä autorizzati alla lettura/scrittura.\n"
$	-	dosopt
...
$	-	dosexec
PROC_EXIT "PROC_EXIT: %1: ERRORE: Il processo necessario %2 ä terminato inaspettatamente.\n\
 Uscita.\n"
$	-	dosexec
$	-	dosopt
$	-aix	pssnap
...
\  L'opzione non ä stata installata."
$	-	dosopt
...
Errno=%2 a=%3 s=%4\n"
$	-aix	dosexec
SITE_NI "SITE_NI: %1: ERRORE: Merge non ä installato in %2.\n"
$	-	dosexec
$	-	dosopt
...
$	-	dosexec
BAD_DRIVE "BAD_DRIVE: %1: ERRORE: lettera dell'unitÖ sbagliata %2.\n"
$	-	dosexec
...
\     Il file non ä attualmente installato.\n"
$	-	dosexec
...
$	-	crt
$	-	dosexec
VM_DIED "VM_DIED: %1: ERRORE: Il processo VM86 ä morto.\n"
...
$	-	dosopt
ZOPT_EXTRA "ZOPT_EXTRA: %1: ERRORE: _ ammessa una sola opzione dopo 'z'.\n"
$	-	dosopt
...
\             modifiche al DOS.\n\
\     +  dX   Imposta l'unitÖ attuale iniziale. X= da a fino a z.\n\
\     +- e[f] Usa il file di configurazione del dispositivo 'f'.\n\
\     +  h    Visualizza informazioni di guida (questo schermo). Il DOS non\n\
\             viene eseguito.\n\
\     +- l[f] Carica il file immagine di dos 'f' ('f' puï anche essere un nome\n\
\             di directory).\n\
...
\     +- dX   Imposta unitÖ iniziale attuale. X= da a fino a z.\n\
\     +- e[f] Usa file di configurazione di dispositivo 'f'.\n\
\     +  h    Schermo di informazioni di guida (questo schermo).\n\
\     +- l[f] Carica file immagine dos 'f' ('f' puï anche essere un nome di\n\
\             directory).\n\
\     +  mn   Dimensione memoria. Il numero 'n' (decimale) ä in Megabyte.\n\
\     +- p[f] Rendi 'Permanente' command.com. 'f' indica quale autoexec.bat\n\
\             eseguire.\n\
\     +- s[n] Trasferisci l'output della stampante DOS alla stampante UNIX.\n\
\             Il timeout ä 'n' secondi.\n\
...
XCRT_NOHELP_MSG "Non ä disponibile la guida."
XCRT_YES_BUTTON_TEXT "Sç"
...
XCRT_TMPL1 "%1 ä zoomato sullo schermo vt%2."
...
XCRT_MSG4 "Zoom non puï proseguire."
XCRT_MSG5 "Fuoco non ä funzionante."
...
XCRT_FREEZE_LABEL "Autoblocco sç"
...
GUI_DRIVES_LABEL	"UnitÖ"
GUI_CONFIGURE_LABEL	"Configura"
GUI_DOS_DRIVE_LABEL	"UnitÖ DOS..."
...
GUI_DEVICES_STATUS_MSG	"C'ä un conflitto tra \n%1 e\n%2."
GUI_MULTI_CONFLICT_MSG  "Rilevati conflitti tra pió\ndispositivi."
...
GUI_FILE_IS_DIR_MSG	"Il file selezionato ä una directory, impossibile aprirla per modificarla."
GUI_PERMISSION_DENIED	"Permesso negato."
GUI_NOT_DIR		"La selezione specificata non ä una directory."
...
ADM_BAD_DRIVE_OPTION "Opzione di unitÖ non valida."
...
ADM_MISSING_DRIVE_NAME "Manca la prevista specifica di nome di unitÖ."
...
ADM_TOKEN_EXISTS "Il token esiste giÖ."
...
CFG_PARSE_DRIVE_DEF	"Definizione di unitÖ non riconosciuta. Usare un token di unitÖ o \"nessuno\"."
CFG_PARSE_DRIVE_OPTION	"Opzione di unitÖ non riconosciuta. Usare \"a sola lettura\" o \"esclusiva\"."
CFG_PARSE_DRIVE_LETTER	"Lettera di unitÖ non ammessa. Sono ammesse solo da C a J."
...
OPTCVT_NOT_DIR		"La directory di configurazione esiste giÖ."
...
OPTCVT_NO_CONVERT	"La configurazione esiste giÖ per l'utente %1.\n"
...
CFG_NOT_DEL	"Non ä possibile cancellare le configurazioni \"dos\" o \"win\"."
CFG_HEADER1	"Questo file ä stato generato con le utility di configurazione di Merge."
...
CFG_DEL_OPT_ERROR "_ possibile cancellare solo le opzioni customdev.\n"
CFG_SET_OPT_ERROR "Si puï specificare una sola opzione.\"
...
CFG_ALREADY_EXISTS "La configurazione \"%1\" esiste giÖ.\n"
...
GEN_ERR_1 "L'installazione non puï essere completata a causa di un errore.\n"
...
I_WARN_1   "Nel kernel in esecuzione ä giÖ installato %1.\n"
I_ERR_1   "%1 non puï essere installato su questo sistema.\n"
...
KERNEL_HAS_MERGE "\n\
Nel kernel di UNIX attualmente in esecuzione ä installato %1.\n\
%2 deve essere rimosso completamente prima della reinstallazione,\n\
altrimenti l'installazione puï fallire e il kernel potrebbe non\n\
...
ALREADY_INSTALLED "Avviso: Driver %1 giÖ installato.\n"
...
REBUILD_WARN "Occorre ricostruire il kernel perchÇ %1 funzioni correttamente.\n"
REBUILD_NEED "Occorre ricostruire il kernel perchÇ il sistema funzioni correttamente.\n"

$ This section (to the line with END-PKGADD) is PKGADD/SVR4 specific.

INST_LOG_HDR "\
# Questo ä un file di log creato dal processo di installazione\n\
...
# e puï essere cancellato dall'utente. Puï anche contenere output non di\n\
# errore da altri programmi UNIX (standard).\n"

REM_LOG_HDR "\
# Questo ä un file di log creato dal processo di rimozione %1.\n\
# Eventuali errori durante la %2 parte controllata della rimozione verranno\n\
# segnalati qui. Questo file viene creato durante l'installazione e puï essere\n\
# cancellato dall'utente. Puï anche contenere output non di errore\n\
...
INST_DONE "L'installazione di %1 ä completa.\n"
...
ERR1 "ERRORE: Non si puï usare l'opzione \"+l\" con %1.\n"

$domain LCC.MERGE.UNIX.INITDPART
$ Messages for the "initdospart" script.

INSERT "Inserire un dischetto ad alta densitÖ nell'unitÖ A: e premere <INVIO>: "
FORMAT "Formattare la partizione DOS del disco.\n"
ERR_1  "ERRORE: Non esiste la partizione DOS sul disco.\n"
ERR_2  "ERRORE: Solo l'utente root puï formattare la partizione DOS.\n"
...
\n\
La formattazione della partizione DOS non ä richiesta, se ä giÖ\n\
...
\       dischetto.\n\
\n\
_ necessario disporre di un dischetto ad alta densitÖ,\n\
facendo attenzione che non sia protetto da scrittura. Questo\n\
dischetto verrÖ formattato e perparato per il riavviamento.\n"
...
RETRY "Verificare che il dischetto usato sia ad alta densitÖ e privo di difetti.\n\
\n\
Riprovare (s/n)? "

REBOOT "\n\
Per formattare la partizione DOS, ä necessario avviare il sistema\n\
dal dischetto che si trova attualmente nell'unitÖ.\n\
\n\
...
ERR_1 "Solo l'utente root o su puï installare il DOS.\n"
ERR_2 "Il DOS ä giÖ installato. Prima di poter eseguire la\n\
...
BAD_FLOP_NAME "Nome di dispositivo dell'unitÖ a dischetti '%1' non valido\n"
...
DSK_DONE "Ora ä possibile togliere il dischetto.\n"
...
\n\
\      1: 3.5\" a bassa densitÖ.\n\
\      2: 3.5\" ad alta densitÖ.\n\
\      3: 3.5\" densitÖ sconosciuta.\n\
\      4: 5.25\" a bassa densitÖ.\n\
\      5: 5.25\" ad alta densitÖ.\n\
\      6: 5.25\" densitÖ sconosciuta.\n\
\      0: Nessuna. Interrompi installazione del DOS.\n\
\n\
Digitare il numero dell'opzione e premere <Invio>: "

DOSINST_FLOP_P "\
Qual'ä l'unitÖ a dischetti usata per l'installazione?\n\
\n\
\      1: La prima unitÖ.   (unitÖ '%1')\n\
\      2: La seconda unitÖ. (unitÖ '%2')\n\
...
DOSINST_FROM "Installazione dall'unitÖ %1.\n"

WRONG_DISK_1 "\
\      Questo disco non sembra essere quello richiesto.\n\
\      Verificare che il disco corretto si trovi nell'unitÖ opportuna.\n"

WRONG_DISK_N "\
\      Questo disco ä giÖ stato letto come disco #%1.\n\
\      Verificare che il disco corretto si trovi nell'unitÖ opportuna.\n"
...
INSERT_S "Inserire il disco DOS %1 nell'unitÖ e premere INVIO. "
INSERT_D "Inserire il disco DOS %1 nell'unitÖ %2 e premere INVIO. "
...
IMPROPER "Il DOS non ä installato appropriatamente.\n"
...
\      Verificare che il disco sia inserito nell'unitÖ corretta.\n"
CLEAN_UP "\
...
CREATE_BOOT_FAIL "\
Avviso: Non ä stato creato il nuovo file boot.dsk.\n\
...
MSG_3 "ä stato modificato dopo l'ultima installazione di Merge.\n"
...
DOS_NI		"Il DOS non ä installato\n"
...
MUST_SU		"Solo l'utente root o su puï generare l'immagine %1.\n"
NATIVE_MUST_SU	"Solo l'utente root o su puï generare l'immagine %1 nativa.\n"
NATIVE_TOKEN	"nativa"
...
LINE06 "≥   di Windows e digitare quanto segue, se si installa dall'unitÖ A:          ≥"
LINE07 "≥                                                                             ≥"
LINE08 "≥                a:\\setup                                                     ≥"
LINE09 "≥                                                                             ≥"
LINE10 "≥   (o b:\\setup se si installa dall'unitÖ B:)                                 ≥"
LINE11 "≥                                                                             ≥"
...
LINE14 "≥                                                                             ≥"
LINE15 "≥ - Per riconfigurare Windows, prima cambiare l'unitÖ e la directory          ≥"
LINE16 "≥   in cui ä stato installato Windows, poi digitare:                          ≥"
LINE17 "≥                                                                             ≥"
LINE18 "≥                setup                                                        ≥"
LINE19 "≥                                                                             ≥"
...
LSET_ESTR9 "lo slot specificato ä in uso"
LSET_ESTR10 "lo slot specificato non ä in uso"
LSET_ESTR11 "il lockset esiste giÖ"
...
RLOCKSHM6 "Config ä valido solo con memoria condivisa del nuovo tipo.\n"
...
RLOCKSHM_OLDST	"AVVISO: Memoria di tipo vecchio in uso -- ä obsoleta\n"
...
LICU_RESOURCE	"La risorsa host non ä disponibile, consultare l'amministratore di sistema."
...
NETIO_CORRUPT	"La tabella interna della rete ä alterata\n"
NETIO_MUXERR	"Errore di multiplexaggio della rete\n"

$ %1 is the size of a network packet
NETIO_PACKET	"La dimensione massima del pacchetto della rete (%1) ä troppo piccola\n"
...
CONSVR_LUID	"La Iuid ä giÖ impostata a %1\n"
...
DEBUG_INVAL	"%1: Il processo %2 non puï essere segnalato, %3\n"
...
DEBUG_BADBIT	"%1: Il canale %2 ä fuori dall'intervallo\n"
