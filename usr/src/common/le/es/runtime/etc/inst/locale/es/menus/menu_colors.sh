...
#
usage(){
echo "Uso: ${CMD_NAME} regular  (establece los colores del menú según los colores de pantalla correspondientes a REGULAR)"
echo "   o: ${CMD_NAME} warn     (establece los colores del menú según los colores de pantalla correspondientes a ADVERTENCIA)"
echo "   o: ${CMD_NAME} error    (establece los colores del menú según los colores de pantalla correspondientes a ERROR)"
return 1
}
