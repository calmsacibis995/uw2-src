...
#
usage(){
echo "Befehlsformat: ${CMD_NAME} regular (stellt Menüfarben auf REGULÄRE Bildschirmfarben ein)"
echo "         oder: ${CMD_NAME} warn    (stellt Menüfarben auf WARNENDE Bildschirmfarben ein)"
echo "         oder: ${CMD_NAME} error   (stellt Menüfarben auf FEHLER-Bildschirmfarben ein)"
return 1
}
