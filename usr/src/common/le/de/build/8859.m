...
$	-	dosexec
$	-	dosopt
AOPT_TOOMANY "AOPT_TOOMANY: %1: FEHLER: Zu viele Ger‰te zugewiesen.\n\
Fortsetzung nicht mˆglich.\n"
$	-	crt
$	-	tkbd
BAD_ARGS "BAD_ARGS: %1: FEHLER: An das Programm wurden falsche Parameter ¸bergeben.\n"
$	-	dosexec
...
\   Verwendung von Tabelle %2 oder %3 nicht mˆglich. Fehlernummer=%4."
$	-	dosopt
BAD_OPT_USAGE "BAD_OPT_USAGE: %1: FEHLER: Falsche Verwendung der Option '%2'.\n"
$	-	dosexec
BAD_SWD "BAD_SWD: %1: FEHLER: ‹bertragungsfehler UNIX-DOS.\n"
$	-	dosexec
BOPT_ERR "BOPT_ERR: %1: FEHLER: 'DOS +b' ist nicht zul‰ssig.\n"
$	-	dosexec
CD_X "CD_X: %1: FEHLER: Anfangs-'cd' in Laufwerk %2 fehlgeschlagen.\n\
Verzeichnis kann nicht zu %3%4 wechseln.\n"
$	-aix	pssnap
$	-	romsnap
CHOWN_ERR "CHOWN_ERR: %1: FEHLER:  Chown bei Datei '%2' nicht mˆglich, Fehlernummer = %3.\n"
$	-	dosexec
CL_TOOLONG "CL_TOOLONG: %1: FEHLER: Befehlszeile zu lang.\n"
$	-	dosexec
CODEPAGE_NS "CODEPAGE_NS: %1: FEHLER: ‹bersetzung von DOS CODEPAGE '%2' wird nicht unterst¸tzt.\n\
\    (CODEPAGE-Datei '%3/%4' nicht gefunden.  err=%5)\n"
$	-	dosexec
CODESET_NS "CODESET_NS: %1: FEHLER: ‹bersetzung des UNIX-Codiersatzes '%2' nicht unterst¸tzt.\n\
...
nicht mˆglich.  ÷ffnen zum Lesen nicht mˆglich.\n"
$	-	newunix
CONS_ONLY "CONS_ONLY: %1: FEHLER: Nur auf der Konsole durchf¸hrbar.\n"
$	-	romsnap
$	-	dosopt
CREATE_ERR "CREATE_ERR: %1: FEHLER: Erstellen von Datei '%2' nicht mˆglich, Fehlernummer = %3.\n"
$	-	dosopt
CRT_DISPLAY "CRT_DISPLAY: %1: FEHLER: Verwendung von Anzeigetyp '%2' mit 'crt' nicht mˆglich.\n"
$	-	dosexec
CWD_TOOLONG "CWD_TOOLONG: %1: FEHLER: Aktuelles Arbeitsverzeichnis ist zu lang %2.\
\nMax=%3.\n"
$	-	dosexec
DA_FAIL "DA_FAIL: Direktanschluﬂ von '%2' nicht mˆglich.  Fehler bei Ger‰t '%3'.\n"
$	-	dosexec
DEV_NA "DEV_NA: %1: FEHLER: Gew¸nschtes Ger‰t %2 nicht verf¸gbar.\n"
$	-	dosexec
DEV_TOOMANY "DEV_TOMANY: %1: FEHLER: Zu viele Ger‰te angeschlossen.\n"
$	-	dosopt
...
$	-	display
DISPLAY_USAGE	"Befehlsformat:  display [ger‰te_name]\n\
\    Wird kein Ger‰tename angegeben, wird die Standardausgabe gew‰hlt.\n"
$	-	dosexec
DMA_NA "DMA_NA: %1: FEHLER: Kann dma-Kanal %2 nicht zuordnen\n"
$	-	dosexec
DOSDEV_ERR "DOSDEV_ERR: %1: FEHLER: Zeile %2 der Ger‰tebeschreibungsdatei\n\
'%3' ist\n\
falsch:\n\
%4\n"
$	-	dosexec
...
zwei Laufwerksbuchstaben, %2 und %3, mit Zugriff SCHREIBEN anzuschlieﬂen. Das ist nicht zul‰ssig. \n\
Fahren Sie mit dem Zugriff NUR LESEN f¸r diese Laufwerke fort.\n"
$	-	dosexec
DPOPT_ERR "DPOPT_ERR: %1: FEHLER: autoexec.bat kann nicht automatisch\
\  auf Laufwerk %2 starten.\n\
(Optionen +p und +d%2 nicht gleichzeitig zul‰ssig)\n"
$	-	dosexec
DRIVE_LETTER "DRIVE_LETTER: %1: FEHLER: Ung¸ltiger Laufwerksbuchstabe %2\n"
$	-	dosexec
...
$	-	dosexec
EXEC_CMDCOM "EXEC_CMDCOM: %1: FEHLER: Ausf¸hrung von command.com fehlgeschlagen.\n"
$	-	dosexec
EXEC_ERR "EXEC_ERR: %1: FEHLER: %2 unsachgem‰ﬂ installiert.\n"
$	-	dosexec
EXEC_FAILED "EXEC_FAILED:  %1:  FEHLER:  Ausf¸hrung von %2 fehlgeschlagen, errno = %3.\n"
$	-	dosexec
...
(Zuviele Prozesse gestartet oder Speicher erschˆpft.)\n"
$
FORK_EXEC_FAIL "FORK_EXEC_FAIL: %1: ERROR: Interne Verzweigung fehlgeschlagen  Fehlernr.=%2\n\
(Zuviele Prozesse gestartet oder Speicher erschˆpft.)\n\
%3 kann nicht ausgef¸hrt werden\n"
$	-	dosexec
IA_FAIL "IA_FAIL: '%2' ist nicht verf¸gbar.\n\
Ger‰t '%3' ist in Betrieb oder hat falsche Berechtigung.\n"
$	-	dosexec
$	-	dosopt
ILL_DRV "ILL_DRV: %1: FEHLER: Ung¸ltiges Laufwerk '%2'.\n"
$	-	dosexec
$	-	dosopt
ILL_MX "ILL_MX: %1: FEHLER: Ung¸ltiger Speicher-Selektor '%2'.\n"
$	-	dosexec
$	-	dosopt
ILL_OPT "ILL_OPT: %1: FEHLER: Ung¸ltige Option '%2'.\nMit +h erhalten Sie Optionsliste.\n"
$	-	dosexec
IMPROPER_INSTL "IMPROPER_INSTL: %1: FEHLER: Unsachgem‰ﬂ installiert.\n\
\  Berechtigungen oder Privilegien sind falsch.\n"
$	-	dosexec
INITDEV_FAIL "INITDEV_FAIL: %1: FEHLER: Initialisierung von '%2=%3' nicht mˆglich.\n"
$	-	dosexec
INIT_FAIL "INIT_FAIL: %1: FEHLER: Initialisierung von Ger‰t '%2' nicht mˆglich.\n"
$	-	dosexec
...
$	-	dosexec
INVALID_DEV "INVALID_DEV: %1: FEHLER: %2 ist kein g¸ltiges Ger‰t. (%3)\n"
$	-	dosexec
INVALID_TMM "INVALID_TMM: %1: FEHLER: %2 ist kein g¸ltiges Ger‰t.\n\
(Ung¸ltiger zugeordneter E/A-Speicherbereich %3-%4)\n"
$	-	dosexec
INVALID_MEMMAP "INVALID_MEMMAP: %1: FEHLER: Ung¸ltiger direkter Anschluﬂ\n\
Abgebildeter E/A-Speicherbereich %2-%3\n"
$	-	dosexec
BAD_PRINTER_CMD "BAD_PRINTER_CMD: Ung¸ltiger Druckerbefehl f¸r %s.\n"
$	-	crt
$	-	xcrt
IOCTL_FAIL "IOCTL_FAIL: %1: FEHLER: Ioctl %2 bei Ger‰t %3 fehlgeschlagen. Errno=%4.\n"
$	-	dosexec
...
$	-	dosexec
MAX_USER "Sart einer weiteren DOS/Windows-Sitzung nicht mˆglich, da die maximal\n\
zul‰ssige Anzahl DOS/Windows-Benutzer (%2) das System aktuell benutzen.\n"
$	-	dosexec
MEM_NA "MEM_NA: %1: FEHLER: Zuordnung von Speicher %2 nicht mˆglich\n"
$	-	dosexec
$	-	dosopt
MEM_OOR "MEM_OOR: %1: FEHLER: Der angeforderte Speicher liegt auﬂerhalb des Bereichs. Max=%2 Min=%3.\n"
$	-	dosexec
MERGE_NA "MERGE_NA: %1: FEHLER: Merge ist f¸r Ihr System nicht konfiguriert.\n\
\  Start von DOS nicht mˆglich.\n"
$	-	dosexec tkbd ...
MERGE_DEV_NA "MERGE_DEV_NA: %1: FEHLER: Zugriff auf Systemaufrufe \"Merge\" nicht mˆglich.\n"
$	-	newunix
...
$	-	dosexec
NO_LICENCE "NO_LICENCE: %1: Es ist keine Lizenz verf¸gbar, um DOS/Windows jetzt auszuf¸hren.\n"
$	-	dosexec
...
$	-	tkbd
$	-	dosexec
NOT_DEV "NOT_DEV: %1: FEHLER: %2 (%3) ist kein Ger‰t.\n"
$	-	dosexec
$	-	dosopt
NOT_DOS_PROG "NOT_DOS_PROG: %1: FEHLER: '%2' ist kein DOS Programm.\n"
$	-	dosopt
NOT_RW_ERR "NOT_RW_ERR: %1: FEHLER: ÷ffnen von Datei '%2' nicht mˆglich.\n\
\  Datei nicht vorhanden oder darf von Ihnen nicht gelesen/geschrieben werden.\n"
$	-	dosopt
NOT_RW_WARN "NOT_RW_WARN: %1: WARNUNG ÷ffnen von Datei '%2' nicht mˆglich.\n\
\  Datei nicht vorhanden oder darf von Ihnen nicht gelesen/geschrieben werden.\n"
$	-	dosexec
$	-	dosopt
$	-	display
$	-aix	pssnap
$	-	romsnap
NOT_R_ERR "NOT_R_ERR: %1: FEHLER: ÷ffnen von Datei '%2' nicht mˆglich.\n\
\  Datei nicht vorhanden bzw. darf von Ihnen nicht gelesen werden.\n"
$	-	dosopt
NOT_R_WARN "NOT_R_WARN: %1: WARNUNG ÷ffnen von Datei '%2' nicht mˆglich.\n\
\  Datei nicht vorhanden bzw. darf von Ihnen nicht gelesen werden.\n"
$	-	dosopt
NOT_W_ERR "NOT_W_ERR: %1: FEHLER: ÷ffnen von Datei '%2' nicht mˆglich.\n\
\  Datei nicht vorhanden bzw. darf von Ihnen nicht geschrieben werden.\n"
$	-	dosexec
NO_BG_CMD "NO_BG_CMD: %1: FEHLER: Ausf¸hrung eines bildschirmorientierten DOS-Programms\n\
\         im Hintergrund nicht mˆglich.  Statt 'DOS ... &' 'DOS ...' verwenden\n"
$	-	dosexec
...
$	-	dosexec
NO_MORE "NO_MORE: %1: FEHLER: Kein Speicherplatz mehr verf¸gbar. Errno=%2\n"
$	-	dosexec
$	-	newunix
NO_RESOURCES "NO_RESOURCES: %1: FEHLER: Keine Ressourcen mehr verf¸gbar.\n"
$	-	newunix
NO_VT "NO_VT: %1: FEHLER: Kein vt verf¸gbar.\n"
$	-	dosexec
NO_VMPROC "NO_VMPROC: %1: FEHLER: Kein vm-Prozeﬂ.\n"
$	-	crt
NO_WIDE "\
\r\n\
\          +===============================+ \r\n\
...
\n"
$	-	dosexec
ON_ERR "ON_ERR: %1: FEHLER: Start des bildschirmorientierten DOS mit ON nicht mˆglich.\n"
$	-	dosexec
...
$	-	romsnap
$	-	tkbd
READ_ERR "READ_ERR: %1: FEHLER: Lesen von Datei '%2'nicht mˆglich.\n"
$	-	dosexec
PORT_NA "PORT_NA: %1: FEHLER: Zuordnung von Port(s) %2 nicht mˆglich\n"
$	- dosexec (SVR4 only)
REBOOT_FOR_PARTITIONS "\
%1: Warnung:\n\
Zugriff auf DOS-Partitionen erst nach Neustart des Systems mˆglich.\n"
$	-	dosopt
RMV_OPTS_ERR1 "RMV_OPTS_ERR1: %1: FEHLER: Entfernen von Option %2 nicht mˆglich.\n\
\  Option war nicht installiert."
$	-	dosopt
RMV_OPTS_ERR2 "RMV_OPTS_ERR2: %1: FEHLER: Entfernen von Option %2 nicht mˆglich.\n\
\  Ung¸ltige Option.\n"
$	-	romsnap
...
$	-	dosexec
SEND_SIG_ERR "SEND_SIG_ERR: %1  Senden von Signal %2 an %3 nicht mˆglich, errno = %4.\n"
$	-	dosexec
SERIOUS	"SERIOUS: Schwerer Fehler in %1:\n%2\n"
$	-	dosexec
SHAREINIT "SHAREINIT: %1: FEHLER: Initialisierung von gemeinsamem Speicherplatzsegment nicht mˆglich.\n\
Fehler = %2 (%3)\n"
$	-	dosexec
SHELL_NF "SHELL_NF: %1: FEHLER: Verwendung von SHELL=%2 nicht mˆglich. Datei nicht gefunden.\n"
$	-	crt
SHMA_FAILED "SHMA_FAILED: %1: FEHLER: Verwendung von gemeinsamem Speicher nicht mˆglich. errno=%2\n"
$	-	dosexec
SHMC_FAILED "SHMC_FAILED: %1: FEHLER: Anlegen von gemeinsamem Speicher nicht mˆglich.\n\
Errno=%2 a=%3 s=%4\n"
$	-aix	dosexec
SITE_NI "SITE_NI: %1: FEHLER: Merge ist auf Anlage %2 nicht installiert.\n"
$	-	dosexec
$	-	dosopt
SOPT_USAGE "SOPT_USAGE: %1: FEHLER: +s Zeit¸berschreitung auﬂerhalb des Wertebereichs.\n\
Wenn Sie keine Zeit¸berschreitung angeben wollen, 0 verwenden.\n\
Wenn Sie eine Zeit¸berschreitung angeben wollen, %2 bis %3 angeben.\n"
$	-	dosexec
SWITCHDOS_FAIL "SWITCHDOS_FAIL: %1: FEHLER: ‹bertragung UNIX-DOS fehlgeschlagen.\n\
errno=%2.\n"
$	-	dosexec
$	-	crt
...
\   Eigenschaften, um ein fernes, bildschirmorientiertes DOS zu unterst¸tzen.\n"
$	-	dosexec
TERM_ERR "TERM_ERR: %1: FEHLER: Kein terminfo f¸r TERM '%2'.\n"
$	-	dosexec
...
$	-	dosexec
LPT_BAD "LPT_BAD: %1: FEHLER: LPT2 und LPT3 kˆnnen nicht auf einen Token-Typ mit direktem Anschluﬂ eingestellt werden."
$	-	dosopt
UI_PROB "UI_PROB: %1: FEHLER: Installation von Datei '%2' nicht r¸ckg‰ngig zu machen.\n\
\     Datei ist derzeit nicht installiert.\n"
$	-	dosexec
UMB_CONFLICT "UMB_CONFLICT: %1: FEHLER: Konflikt bei der Zuweisung von Blˆcken\n\
\     im oberen Speicherbereich (UMBs) %2-%3\n"
$	-	dosexec
UPOPT_ERR "UPOPT_ERR: %1: FEHLER: Gleichzeitige Verwendung der Optionen +p und +ut\
\  unzul‰ssig.\n"
$	-	dosexec
VECT_NA "VECT_NA: %1: FEHLER: Zuordnung von Interrupt-Vektor %2 nicht mˆglich\n"
$	-	crt
...
$	-	crt
$	-	dosexec
VM_DIED "VM_DIED: %1: FEHLER: Der VM86-Prozeﬂ wurde abgebrochen.\n"
$	-	dosexec		janus_main.c
WAIT_RET_ERR "WAIT_RET_ERR: %1:  FEHLER:  Systemaufruf \"Wait\" kommt zu fr¸h zur¸ck\n\
errno = %2.\n"
$	-	dosopt
$	-aix	pssnap
$	-	romsnap
WRITE_ERR "WRITE_ERR: %1: FEHLER: Schreiben von Datei '%2' nicht mˆglich.\n"
$	-	dosopt
ZOPT_ERR "ZOPT_ERR: %1: FEHLER: Verwendung von Option 'z' oder 'Z' f¸r\n\
eine Standardwertedatei %2 nicht mˆglich.\n"
$	-	dosopt
...
$	-	dosopt
ZOPT_TOOMANY "ZOPT_TOOMANY: %1: FEHLER: Zu viele +z-Objekte angegeben. Fortfahren nicht mˆglich.\n"
$	-	dosexec
HELP_EXEC "\n\
\   Verwendung: %1 [Flaggen] Dateiname Argum....\n\
\   Verwendung: %1 [Flaggen]\n\
\   Das erste Formular f¸hrt den DOS-Dateinamen aus, das zweite Formular\n\
\   f¸hrt 'command.com' von DOS aus.  Die Flaggen ¸berschreiben\n\
\   Standardvorgaben und installierte Optionen und geben Anweisungen zur\n\
\   Aufhebung normaler ausf¸hrbarer DOS-Operationen.\n\
\   ('+' zeigt Optionsauswahl, '-' zeigt R¸ckg‰ngigmachung der Optionsauswahl an.)\n\
\     +- a[x] Ger‰t zuweisen 'x'.\n\
\     +- b    Sich gut verhaltendes Programm. (stdio von/zu UNIX umleiten)\n\
\     +  c    Befehl: Der DOS-Befehlsdateiname wird unge‰ndert an DOS \n\
\             weitergegeben.\n\
\     +  dX   Momentanes Initialisierungslaufwerk festlegen. X= a bis z.\n\
\     +- e[f] Ger‰tekonfigurationsdatei 'f' verwenden.\n\
\     +  h    Hilfe-Informationen angezeigt (dieser Bildschirm). DOS wird\n\
\             nicht ausgef¸hrt.\n\
\     +- l[f] Bilddatei 'f' laden ('f' kann ebenso Verzeichnisname sein).\n\
\     +  mn   Speichergrˆﬂe. Zahl 'n' (dezimal) in Megabyte.\n\
\     +- p[f] command.com 'Permanent' machen. Die auszuf¸hrende autoexec.bat ist 'f'.\n\
\     +- s[n] DOS-Druckerausgabe an UNIX Drucker spulen. Zeit¸berschreitung ist 'n' Sekunden.\n\
\     +- t    DOS-Befehlszeilenargumente ¸bersetzen.\n"

$ 	-	dosopt
HELP_INST "\n\
Befehlsformat: %1 [Flaggen] Dateinamen\n\
\   Optionen f¸r Dateinamen installieren. Installationsflaggen haben anf‰ngl. '+' oder '-'.\n\
\   Die anf‰ngl. '+' oder '-' geben Ausw‰hlen oder Entfernen der Option an.\n\
\   Wenn keine Optionen oder Anweisungen vorhanden sind, werden die aktuellen Optionen gedruckt.\n\
\     +- a[x] Ger‰t 'x' zuweisen.\n\
...
\     +  mn   Speichergrˆﬂe. Zahl 'n' (dezimal) in Megabyte.\n\
\     +- p[f] command.com auf 'Permanent' einstellen. 'f' steht f¸r die auszuf¸hrende Datei autoexec.bat.\n\
\     +- s[n] DOS-Druckerausgabe zu UNIX-Drucker spulen. Zeit¸berschreitung gleich 'n' Sekunden.\n\
\     +- t    DOS-Befehlszeilenargumente ¸bersetzen.\n\
\     +- v    Verbos. Best‰tigungsmeldung anzeigen.\n\
\     +  y    COM-Dateien kˆnnen von UNIX ausgef¸hrt werden.  Wird nicht benˆtigt, \n\
\             wenn andere Optionen eingestellt sind.\n\
\     +  zX   Option X entfernen oder zur¸cksetzen.\n\
...
PM_INIT_BAD_PARAM "\
%1: FEHLER-  Ung¸ltiger Parameter f¸r ifor_pm_init_sco.  (IFOR_PM_BAD_PARAM)\n"
$
...
$ --- For return value:  IFOR_PM_BAD_PARAM
PM_REQ_BAD_PARAM "\
%1: FEHLER-  Ung¸ltiger Parameter f¸r ifor_pm_request_sco.  (IFOR_PM_BAD_PARAM)\n"
$
$ --- For return value:  IFOR_PM_NO_INIT
PM_REQ_NO_INIT "\
%1: FEHLER-  F¸r die Initialisierung des Policy Managers ist eine Lizenz erforderlich.  \n\
(IFOR_PM_NO_INIT)\n"
$
$ --- For return value:  IFOR_PM_FATAL
PM_REQ_FATAL "\
...
%1: WARNUNG-  Ung¸ltiger Parameter f¸r ifor_pm_release.  (IFOR_PM_BAD_PARAM)\n"
$
$ --- For return value:  IFOR_PM_FATAL
PM_RELEASE_FATAL "\
...
XDOSOPT_COM_TITLE "COM-Anschl¸sse"
...
XDOSOPT_LPT_TITLE "LPT-Anschl¸sse"
...
XDOSOPT_QUIT_MSG "Sie haben die ƒnderungen nicht angewendet.\nMˆchten Sie wirklich beenden?"
XDOSOPT_YES_BUTTON "Ja"
XDOSOPT_NO_BUTTON "Nein"
XDOSOPT_OK_BUTTON "OK"
XDOSOPT_SAVE_ERR_MSG "Sie sind nicht berechtigt, f¸r diese\nDatei ƒnderungen zu speichern."
XDOSOPT_MEM_TITLE "Speicher"
XDOSOPT_XMEM_NAME "Standard"
XDOSOPT_EMEM_NAME "EMS"
XDOSOPT_CONFIG_READ_MSG "Lesen der DOS- oder Windows-Konfiguration nicht mˆglich."
...
XCRT_NOHELP_MSG "Keine Hilfe verf¸gbar."
XCRT_YES_BUTTON_TEXT "Ja"
XCRT_NO_BUTTON_TEXT "Nein"
XCRT_OK_BUTTON_TEXT "OK"
XCRT_NODEV_ERR "Fehler: Ger‰t %1 nicht verf¸gbar."
XCRT_INTR_ERR "Fehler: MERGE-interner Fehler."
XCRT_VT_ERR "Fehler: Erhalt einer neuen Bildschirmanzeige nicht mˆglich."
XCRT_SERVER_ERR "Fehler: Server gibt Anzeige nicht frei."
XCRT_NOMSE_ERR "DOS Sitzung ist nicht f¸r Maus eingerichtet."
XCRT_TMPL1 "%1 wird auf Bildschirm vt%2 gezoomt."
XCRT_TMPL2 "%1 dr¸cken, um das DOS Men¸ aufzurufen."
XCRT_MSG1 "EGA/VGA-Grafiken sind nicht in einem Fenster verf¸gbar."
XCRT_MSG2 "DOS Fenster verlassen und DOS neu starten."
XCRT_MSG3 "W‰hlen Sie im Fenstermen¸ \"Zomm\", um Graphiken auszuf¸hren."
XCRT_MSG4 "Zoom kann nicht fortgesetzt werden."
XCRT_MSG5 "Fokus ist nicht betriebsbereit."
XCRT_VERSION_ERROR "Ihr Bildschrimtreiber f¸r DOS Merge Windows/X muﬂ aktualisiert\n\
...
XCRT_PICTURE_ERROR "Anzeige des Bilds nicht mˆglich. Versuchen\nSie eine Bildschirmauflˆsung von mindestens 800x600\nund mindestens 256 Farben."
$	- 	xcrt - Old GUI Messages
XCRT_MENU_TITLE "DOS Men¸"
...
XCRT_UNZOOM_LABEL "Vergrˆﬂerung aufheben"
XCRT_NORMAL_KEYS_LABEL "DOS Tasten"
XCRT_WINDOW_KEYS_LABEL "Desktop-Tasten"
XCRT_OLD_MSG3 "Im DOS Men¸ auf Zoom klicken, um Graphiken zu starten."
$	- 	xmrgconfig
GUI_OK			"OK"
...
GUI_HOME_LABEL		"Home"
GUI_DEVICES_BUTTON_LABEL "Ger‰te"
...
GUI_COM_PORTS_LABEL	"COM-Anschl¸sse"
GUI_COM1_LABEL		"COM1"
GUI_COM2_LABEL		"COM2"
GUI_LPT_PORTS_LABEL	"LPT-Anschl¸sse"
GUI_LPT1_LABEL		"LPT1"
GUI_LPT2_LABEL		"LPT2"
GUI_LPT3_LABEL		"LPT3"
GUI_TIMEOUT_LABEL	"Zeit¸berschreitung"
GUI_DEVICES_LABEL	"Ger‰te"
...
GUI_RUN_SYS_LABEL	"Systemweit ausf¸hren"
GUI_PERSONAL_LABEL	"Nur persˆnliche ausf¸hren"
GUI_OTHER_LABEL		"Andere"
GUI_BROWSE_LABEL	"Bl‰ttern..."
GUI_EDIT_LABEL		"Dateien bearbeiten"
GUI_AUTOEXEC_MNEMONIC	"A"
GUI_SYS_AUTO_LABEL	"Systemweite AUTOEXEC.BAT..."
GUI_PERSONAL_AUTO_LABEL "Persˆnliche AUTOEXEC.BAT..."
...
GUI_PERSONAL_CONFIG_LABEL "Persˆnliche CONFIG.SYS..."
GUI_OTHER_CONFIG_LABEL	"Andere CONFIG.SYS..."
GUI_WINDOWS_SIZE_LABEL	"Windows-Grˆﬂe"
GUI_CUSTOM_LABEL	"Individuell:"
GUI_RESIZE_LABEL	"Manuelle Grˆﬂenanpassung..."
GUI_WIDTH_LABEL		"Breite:"
GUI_HEIGHT_LABEL	"Hˆhe:"
GUI_DOS_SIZE_LABEL	"DOS-Grˆﬂe"
...
GUI_MEDIUM_LABEL	"Datentr‰ger"
GUI_LARGE_LABEL		"Groﬂ"
GUI_X1_LABEL		"x1"
GUI_X2_LABEL		"x2"
GUI_MDA_LABEL		"MDA"
...
GUI_EXCLUSIVE_LABEL	"Ausschlieﬂlich"
GUI_FILES_LABEL	 	"Dateien"
GUI_FILTER_LABEL	"Filter"
GUI_DIRECTORIES_LABEL	"Verzeichnisse"
GUI_SELECTION_LABEL	"Auswahl"
GUI_RESIZE_TITLE	"Windows Fenstergrˆﬂe"
GUI_FILE_LABEL		"Datei"
GUI_RESIZE_MESSAGE	"Verwenden Sie Ihre Maus oder Tastatur, um die Grˆﬂe dieses\nFenster auf Ihre bevorzugte Microsoft Windows Fenstergrˆﬂe\neinzustellen."
GUI_STATUS_MSG		"Statuszeile"
GUI_CONFIRM_MSG		"Sie haben die Konfiguration ver‰ndert.\nSind Sie sicher, daﬂ Sie beenden wollen?"
GUI_FILE_DOESNT_EXIST_MSG "Datei existiert nicht."
GUI_DIR_DOESNT_EXIST	"Verzeichnis existiert nicht."
GUI_FILE_IS_DIR_MSG	"Ausgew‰hlte Datei ist ein Verzeichnis, kann nicht f¸r Bearbeitung geˆffnet werden."
...
GUI_OPEN_CONFIG_ERROR	"Fehler beim ÷ffnen der Konfigurationsdatei."
...
GUI_DELETE_CONFIG_ERROR	"Konfigurationsdatei kann nicht gelˆscht werden."
GUI_ALREADY_EXISTS	"Konfiguration \"%1\" existiert bereits."
GUI_CONFLICT_MSG	"Folgende Ger‰te stehen untereinander in Hardware-Konflikt:\n%1.\nUm diese Konflikte zu lˆsen, machen Sie die Auswahl eines oder\nmehrerer dieser Objekte im Bereich \"Ger‰te\" r¸ckg‰ngig.\nWenn Sie diese Ger‰te miteinander verwenden wollen, m¸ssen\nSie eines oder mehrere neu konfigurieren, um\nHardware-Konflikte zu vermeiden."
GUI_DRIVE_WARNING	"Warnung: \"%1\" existiert nicht."
GUI_CANT_START		"DOS- oder Windows-Sitzung kann nicht gestartet werden."
GUI_NO_DRIVES_ERROR	"Kein DOS Laufwerke verf¸gbar."
GUI_CANT_READ_FILE	"Datei \"%1\" nicht lesbar."
GUI_CANT_CREATE_FILE	"Datei \"%1\" nicht lesbar."
GUI_VIEW_FILE_MSG	"Die Datei \"%1\" ist nicht beschreibbar, mˆchten Sie sie einsehen?"
GUI_CREATE_FILE_MSG	"Die Datei \"%1\" existiert nicht, mˆchten Sie sie erstellen?"
$	-	mrgadmin messages
ADM_USAGE_CMD "Befehlsformat:\tmrgadmin class add Token:Datei:vollst‰ndiger Name\n\t\tmrgadmin class delete Token\n\t\tmrgadmin class list [Token]\n\t\tmrgadmin class update Token:Datei:vollst‰ndiger Name\n\t\tmrgadmin class printdef Token\n"
ADM_CLASS_MSG "Fehler: zugelassene Klassen sind:\n"
ADM_NO_CLASS_MSG "Kann keine Informationen ¸ber Klasse \"%1\" erhalten.\n"
ADM_NO_CLASS_ENTRIES_MSG "Keine Eintr‰ge f¸r Klasse \"%1\" gefunden.\n"
ADM_BAD_TOKEN_MSG "Kann keine Informationen ¸ber Token \"%1\" erhalten.\n"
ADM_PERMISSION_MSG "Sie m¸ssen root sein, um die Merge Verwaltung zu ‰ndern.\n"
ADM_CANT_DELETE_TOKEN_MSG "Token \"%1\" kann nicht gelˆscht werden\n"
ADM_BAD_TOKEN_DEF_MSG "Die Token-Definition muﬂ folgende Form haben: \"Token:Datei:Name\".\n"
ADM_CANT_READ_MSG	"Lesen von \"%1\" nicht mˆglich: %2.\n"
$	-	mrgadmin commands
ADM_ADD_STR		"add"
...
ADM_PARSE_NO_NUMBER "Es muﬂ eine Nummer angegeben werden."
ADM_PARSE_NUMBER "Unzul‰ssiger numerischer Wert."
ADM_PARSE_ILLEGAL_VARIABLE "Variable f¸r angegebenen Anschluﬂtyp nicht zugelassen."
ADM_PARSE_MAX_NUMBERS "Anzahl der maximal zugelassenen Elemente ¸berschritten."
ADM_MEMORY "Kein Speicherplatz mehr."
ADM_PARSE_MAX_NUMBER "Maximaler numerischer Wert ¸berschritten."
ADM_PARSE_RANGE "Fehlerhafte Bereichsangabe."
ADM_BAD_ATTACH "Fehlerhafte Anschluﬂtyp-Angabe."
ADM_BAD_DEV_TYPE "Fehlerhafte Ger‰tetyp-Angabe."
...
ADM_IRQ_MISMATCH "irq und physicalirq stimmen nicht ¸berein."
ADM_DMA_MISMATCH "dma und physicaldma stimmen nicht ¸berein."
ADM_IOPORTS_MISMATCH "ioports und physicalioports stimmen nicht ¸berein."
ADM_MEM_MISMATCH "memmappedio und physicalmemmappedio stimmen nicht ¸berein."
...
ADM_NO_ATTACH "Erforderliche Anschluﬂtyp-Angabe fehlt."
ADM_PARSE_OPTION "Unerkannte Optionswerte."
ADM_BAD_UMB "Unzul‰ssige UMB-Angabe. Sie muﬂ innerhalb des Bereichs 0xA0000-0xFFFF liegen."
$       -       admconvert-Meldungen
ADMCVT_CANT_OPEN "\"%1\" kann nicht geˆffnet werden.\n"
ADMCVT_CANT_CREATE "Erstellen von \"%1\" nicht mˆglich\n"
ADMCVT_BAD_FORMAT "Formatfehler in /etc/dosdev.\n"
ADMCVT_MEMORY "kein Speicherplatz mehr\n"
ADMCVT_CANT_ADD "Token \"%1\" kann nicht hinzugef¸gt werden: %2\n"
ADMCVT_LP_CONVERT "/usr/lib/merge/lp kann nicht umgewandelt werden.\n"
ADMCVT_DOS_DRIVE_NAME "Urspr¸ngliches DOS %1:"
...
CFG_PARSE_DRIVE_LETTER	"Unzul‰ssiger Laufwerksbuchstabe. Nur C bis J sind zugelassen."
CFG_PARSE_NUMBER	"Unzul‰ssiger numerischer Wert."
CFG_PARSE_SCALE_VALUE	"Unerkannter scaledosgraphics-Wert. Verwenden Sie \"auto\", \"1\"," oder \"2\"."
CFG_PARSE_NO_NUMBER	"Es muﬂ eine Nummer angegeben werden."
CFG_PARSE_OPTION	"Unerkannte Optionswerte."
CFG_PARSE_FONT		"Unerkannter Schriftartwert. Verwenden Sie \"auto\", \"small\", oder \"medium\"."
CFG_UNZOOM_KEY		"Es muﬂ ein X-Schl¸sselname angegeben werden."
OPTCVT_BAD_USER		"Kann keine Informationen f¸r aktuellen Benutzer bekommen."
OPTCVT_BAD_USER2	"Kann keine Informationen f¸r Benutzer %1 bekommen.\n"
...
OPTCVT_ADM_ERROR	"Verwaltungsfehler w‰hrend der Konvertierung."
OPTCVT_BAD_OPTIONS	"Befehlsformat: optconvert [-c Benutzer]\n"
OPTCVT_NO_CONVERT	"Konfiguration existiert bereits f¸r Benutzer %1.\n"
OPTCVT_BAD_LOG		"Protokoll %1 kann nicht geschrieben werden.\n"
OPTCVT_BAD_CONVERT	"+a%1 kann nicht umgewandelt werden.\n"
CFG_BAD_DIR		"Konfigurationsverzeichnis kann nicht geˆffnet werden."
CFG_MEMORY		"Kein Speicherplatz mehr."
CFG_SYSERR		"Systemfehler."
CFG_BAD_NAME		"Unzul‰ssiger Konfigurationsname."
CFG_NOT_DEL	"Sie kˆnnen die Konfigurationen \"dos\" oder \"win\" nicht lˆschen."
CFG_HEADER1	"Diese Datei wurde mit Merge-Konfigurationsdienstprogrammen erstellt."
CFG_HEADER2	"Verwenden Sie die Konfigurationsdienstprogramme, um ƒnderungen an dieser Datei vorzunehmen."
$	-	mrgconfig
CFG_BAD_CMD	"Interner Fehler - unerkannter Befehl.\n"
CFG_YES_RESP	"y"
CFG_NO_RESP	"n"
CFG_CONFIRM	"Wollen Sie \"%1\" wirklich lˆschen?"
CFG_RESPONSE	"Bitte antworten Sie \"%1\" oder \"%2\"\n"
CFG_CANT_DELETE "Lˆschen von \"%1\" nicht mˆglich."
CFG_DELETED	"Konfiguration \"%1\" gelˆscht.\n"
CFG_NOT_DELETED	"Konfiguration \"%1\" nicht gelˆscht.\n"
...
CFG_DEL_OPT_ERROR "Sie kˆnnen nur customdev-Optionen lˆschen.\n"
CFG_SET_OPT_ERROR "Sie kˆnnen nur eine Option angeben.\n"
...
CFG_DEL_VALUE_ERROR "Sie m¸ssen einen customdev-Wert angeben.\n"
CFG_DEL_NOT_FOUND "Individuelles Ger‰t \"%1\" existiert nicht in Konfiguration \"%2\".\n"
...
CFG_NOLIST_MSG	"Es sind keine Konfigurationen aufzuf¸hren.\n"
...
GEN_ERR_1 "Fehler verhindert den Abschluﬂ der Installation.\n"
GEN_ERR_2 "%1 auf Ausgabefehler untersuchen.\n"
GEN_ERR_3 "Schlieﬂen und Beenden...\n"
...
I_ERR_2   "Das Unix Base Package muﬂ eine Unterst¸tzung f¸r %1\n\
enthalten, sonst ist zun‰chst eine\n\
Aktualisierung von UNIX Base Package zu installieren.\n"

KERNEL_HAS_MERGE "\n\
Beim laufenden UNIX Kernecho ist %1 installiert. %2 ist vor der\n\
Neuinstallation ganz zu entfernen, sonst kˆnnen Installationsfehler\n\
auftreten und Kern wird mˆglicherweise nicht sachgem‰ﬂ verkettet.\n"

NO_STREAMS "\n\
Streams-Treiber nicht installiert.  Der Streams-Treiber muﬂ installiert\n\
sein, damit %1 installiert werden kann.\n"

CANT_INST  "Installation von %1 nicht mˆglich.\n"
CANNOT_REMOVE "Entfernen von %1 nicht mˆglich.\n"
...
REMOVE_4 "Die Installation der Verteilerdateien %1 wurde r¸ckg‰ngig gemacht.\n"

IDIN_FAIL "idinstall von %1 fehlgeschlagen.\n" \
ALREADY_INSTALLED "Warnung: Treiber %1 bereits installiert.\n"
IDCHK_FAIL  "idcheck -p von %1 zur¸ckgegeben %2\n"

LINK_FAIL_1 "Verkn¸pfung einer Datei fehlgeschlagen.\n"
LINK_FAIL_2 "Verkn¸pfung fehlgeschlagen: %1 %2\n"
...
YESES "jJ"
NOES "nN"
LINK_NOW_Q "Mˆchten Sie jetzt einen neuen Kern aufbauen? (j/n) "
Y_OR_NO "Antworten Sie mit \"j\" oder \"n\": "
REBUILD_WARN "Sie m¸ssen den Kern neu aufbauen, damit %1 richtig funktioniert.\n"
REBUILD_NEED "Sie m¸ssen den Kern neu aufbauen, damit das System richtig funktioniert.\n"

$ This section (to the line with END-PKGADD) is PKGADD/SVR4 specific.

INST_LOG_HDR "\
# Diese Protokolldatei wurde mit dem Installationsprozeﬂ %1 erstellt.\n\
# Wenn w‰hrend dem von %2 gesteuertenTeil der Installation ein Fehler\n\
# auftritt, wird er hier angezeigt. Die Datei wird w‰hrend der Installation\n\
# erstellt und kann vom Benutzer gelˆscht werden. Diese Datei\n\
# kann ebenfalls nicht-Fehler-Ausgabe von anderen (Standard-) UNIX\n\
# Programmen enthalten.\n"

REM_LOG_HDR "\
# Diese Protokolldatei wurde mit dem Entfernprozeﬂ %1 erstellt.\n\
#  Wenn w‰hrend des von %2 gesteuerten Teil des Entfernens ein\n\
# Fehler auftritt, wird er hier angezeigt.  Die Datei wird w‰hrend des\n\
# Entfernens erstellt und kann vom Benutzer gelˆscht werden. Diese Datei\n\
# kann ebenfalls nicht-Fehler-Ausgabe von anderen (Standard-) UNIX\n\
# Programmen enthalten.\n"
...
REM_DONE "%1 wurde vollst‰ndig entfernt.\n"
...
Es muﬂ erst entfernt werden, bevor es neu installiert werden kann.\n\n"
...
USAGE "BEFEHLSFORMAT: %1 vollst‰ndiger_Dateipfadname [-s]\n"
...
INSERT "HD-Diskette in Laufwerk A: einlegen und <EINGABETASTE> dr¸cken: "
...
\n\
‹berpr¸fen Sie, ob sie nicht schreibgesch¸tzt ist.\n"

ERR_4  "FEHLER:  Die Diskette scheint fehlerhaft zu sein.\n"

TEXT_1 "Die DOS-Partition ist vor dem Gebrauch zu\n\
\n\
formatieren. Die DOS Plattenpartition muﬂ nicht formatiert werden,\n\
wenn die Formatierung bereits durchgef¸hrt und die Partition\n\
seither weder vergrˆﬂert noch verschoben wurde.\n\
\n\
Warnung: Die Formatierung der DOS Partition wird alle darin\n\
\           befindlichen Daten lˆschen.\n\
Warnung: Um die DOS Partition zu formatieren, m¸ssen Sie das System\n\
\           herunterfahren und von einer Diskette neu starten.\n\
\n\
Sie benˆtigen daf¸r eine HD-Diskette. Stellen Sie sicher,\n\
daﬂ sie nicht schreibgesch¸tzt ist. Diese Diskette wird formatiert\n\
...
CONTINUE "Mˆchten Sie weitermachen (j/n)? "
Y_OR_N "Antworten Sie mit \"j\" oder \"n\": "
YESES "jJ"
NOES  "nN"

RETRY "Verwenden Sie eine unbesch‰digte HD-Diskette.\n\
\n\
Mˆchten Sie es noch einmal versuchen (j/n)? "

REBOOT "\n\
Um die DOS Partition zu formatieren, muﬂ das System von der\n\
Diskette geladen werden, die sich gerade im Laufwerk befindet.\n\
\n\
Die Diskette NICHT herausnehmen\n\
\n\
<EINGABETASTE> dr¸cken, um das System vor dem Neustart herunterzufahren. "

EXIT   "Die DOS Partition wird nicht formatiert.\n"
EXIT_2 "Die DOS Partition muﬂ vor dem Gebrauch formatiert werden.\n"
...
ERR_1 "Nur Root oder Superuser kˆnnen DOS installieren.\n"
ERR_2 "DOS ist bereits installiert. Das aktuell installierte DOS\n\
muﬂ vor der Neuinstallation entfernt werden.\n"
CANNOT_CONTINUE "Fortfahren nicht mˆglich.\n"
...
BAD_FLOP_NAME "Ung¸ltiger Ger‰tename des Diskettenlaufwerks '%1'\n"

RM_MSG "DOS wird entfernt\n"
ERR_RM "Schwierigkeiten beim Entfernen von DOS.\n\
Installation von DOS kˆnnte fehlschlagen.\n"
...
DSK_DONE "Sie kˆnnen die Diskette jetzt herausnehmen.\n"

DOSINST_MKIMG_FAILED "Nicht alle DOS Bilddateien wurden erstellt.\n\
\     Die Installation von DOS ist teilweise fehlgeschlagen.\n"

DOSINST_MKIMG_MONO_FAILED "Erstellen von Mono-DOS Bilddateien nicht mˆglich.\n\
\     Installation von DOS wird abgebrochen.\n"

NO_SPACE    "     Nicht gen¸gend Platz.\n"
NO_SPACE_IN "     Nicht gen¸gend Platz in %1\n"
NEED_SPACE  "     Benˆtigt: %1 Blˆcke, Vorhanden: %2.\n"

DOSINST_CANT "%1 kann nicht installiert werden\n"

DOSINST_DOSBRAND_MENU1 "W‰hlen Sie aus, welches DOS Sie installieren wollen.\n"

DOSINST_DOSBRAND_MENU2 "\
\      0: Keines der oben genannten. DOS Installation abbrechen.\n\
\n\
Geben Sie die Optionsnummer ein und dr¸cken dann die Eingabetaste: "
...
Bitte geben Sie die Grˆﬂe Ihrer DOS Disketten ein.\n\
\n\
...
\n\
Geben Sie die Optionsnummer ein und dr¸cken die Eingabetaste: "

DOSINST_FLOP_P "\
Von welchem Diskettenlaufwerk wird die Installation durchgef¸hrt?\n\
\n\
\      1: Erstes Laufwerk.  (Laufwerk '%1')\n\
\      2: Zweites Laufwerk. (Laufwerk '%2')\n\
\      0: Stop.  DOS Installation abbrechen.\n\
\n\
Geben Sie die Nummer ein und dr¸cken dann die Eingabetaste: "
...
\      Bitte pr¸fen Sie, ob die richtige Diskette im angegebenen Laufwerk ist.\n"
...
DOSINST_DW_P "\
Was mˆchten Sie jetzt tun:\n\
\      0: Die Installation von DOS abbrechen.\n\
\      1: Erneut versuchen.\n\
Geben Sie 0 oder 1 ein, und dr¸cken Sie die Eingabetaste: "

DOSINST_DW_R "Geben Sie 0 oder 1 ein\n"

DOSINST_NOTINST "DOS wird nicht installiert.\n"
DOSINST_AUTO_NA "\
Automatische Installation von DOS nicht mˆglich.\n\
F¸hen Sie das Programm 'dosinstall' aus, um DOS von Ihrem DOS\n\
Diskettenlaufwerk aus zu installieren.\n"

CHECK_DISK  "Diskette wird ¸berpr¸ft."
INSERT_S "DOS Diskette %1 in Laufwerk einlegen und EINGABETASTE dr¸cken. "
INSERT_D "DOS Diskette %1 in Laufwerk %2 einlegen und EINGABETASTE dr¸cken. "
INSERT_NEXT "Diskette %1 herausnehmen, Diskette %2 einlegen und EINGABETASTE dr¸cken. "
INST_CANCEL "Installation vom Benutzer abgebrochen.\n"
...
Q_REMOVE "Mˆchten Sie das aktuell installierte DOS jetzt entfernen (j/n/b)? "
Q_CONTINUE "Mˆchten Sie die DOS Installation fortsetzen (j/n/b)? "
Q_ANYWAY "Mˆchten Sie DOS trotzdem entfernen (j/n/b)? "
...
RM_PROB_1 "Fehlende Dateiliste. DOS kann nicht vollst‰ndig entfernt werden.\n"
RM_ALMOST "DOS wurde entfernt.\n"
RM_DONE "DOS wurde entfernt.\n"
BAD_DISK "\
\     Probleme beim Lesen der Diskette.\n\
\     ‹berpr¸fen Sie, ob die Diskette richtig ins Laufwerk eingelegt ist.\n"
CLEAN_UP "\
Zum Abschluﬂ der DOS Installation mehr Plattenspeicher bereitstellen und neu starten.\n"
...
MSG_1 "Vergleich der Datei-Pr¸fsummen f¸r\n"
MSG_2 "mit den Werten in %1...\n"
MSG_3 "wurde seit der letzten Installation von Merge ge‰ndert.\n"
MSG_4 "Pr¸fsumme in %1 kann nicht ermittelt werden.\n\
Fahre fort...\n"
MSG_5 "Dateipr¸fung ausgef¸hrt.\n"
...
CONTINUE "        Dr¸cken Sie die [EINGABETASTE], um fortzufahren"
REMOVE "\n\
\         ENTFERNEN\n\
\         ---------------------\n\
\         Druckername: "
...
-----------------------------------------------\n"
MISSING_PROG	"Programm %1 fehlt.\n"
NO_LP		"Mˆglicherweise ist der LP-Druckdienst nicht installiert.\n"
CANNOT_CONTINUE	"Fortfahren nicht mˆglich.\n"
...
CREATE_NOROOM	"Nicht gen¸gend Platz f¸r die Erstellung von Datei %1\n"
...
MUST_SU		"Nur Root oder Superuser kˆnnen Abbild %1 herstellen.\n"
NATIVE_MUST_SU	"Nur Root oder Superuser kˆnnen systemeigenes Abbild %1 herstellen.\n"
...
NO_PERMIS_TMP	"Keine Berechtigung zur Erstellung der tempor‰ren Datei %1\n"
NO_PERMIS_WRITE	"Keine Berechtigung zum Schreiben von %1\n"
NO_ROOM		"(Kein Platz mehr?)\n"
NO_ROOM_TMP	"Nicht ausreichend Platz zur Erstellung der tempor‰ren Datei %1\n"
...
\n\
Schriftarten kˆnnen auf vier verschiedene Arten kompiliert\n\
...
X-Versionen verwenden verschiedene Optionen f¸r die\n\
...
MFM_BAD_SECONDP	"Fehler: Als zweiter Parameter muﬂ 's', 'ML' oder nichts angegeben werden.\n"
...
MFM_01234	"Fehler: Sie m¸ssen 0, 1, 2, 3 oder 4 verwenden.\n"
MFM_U_NOPERMIS	"Fehler: Keine Berechtigung zur Aktualisierung von %1\n"
MFM_FC_ERR	"Fehler: %1 gab %2 zur¸ck\n"
...
LSET_ESTR4 "Sperren/Entsperren der Tabelle nicht mˆglich"
LSET_ESTR5 "IPC-Identifikator nicht erhalten"
LSET_ESTR6 "Sperrsatz erstellen bzw.darauf zugeifen nicht mˆglich"
LSET_ESTR7 "kann gemeinsames Speicherplatzsegment nicht anschlieﬂen"
...
RLOCKSHM6 "Config ist nur mit neuartigem gemeinsam benutztem Speicher g¸ltig.\n"
RLOCKSHM7 "%1 von gemeinsam genutztem Speicher nicht mˆglich, "
RLOCKSHM8 "(Systemfehler: %1).\n"
RLOCKSHM9 "%1.\n"
RLOCKSHM10 "\nStandardkonfigurations-Informationen:\n\n"
RLOCKSHM11 "\tSegmentanschluﬂ-Adresse\t\t(Programm ausgew‰hlt)\n"
RLOCKSHM12 "\tSegmentanschluﬂ-Adresse\t\t%1\n"
RLOCKSHM14 "\tSchl¸ssel f¸r gemeinsam benutzten Speicher\t\t%1\n"
RLOCKSHM15 "\tSperrsatzschl¸ssel\t\t\t%1\n"
RLOCKSHM17 "\tTabelleneintr‰ge f¸r geˆffnete Dateien\t\t%1\n"
RLOCKSHM18 "\tTabelleneintr‰ge f¸r Datei-Header\t%1\n"
RLOCKSHM19 "\tTabelleneintr‰ge f¸r Hash-Dateien\t%1\n"
RLOCKSHM20 "\tTabelleneintr‰ge f¸r Datensatzsperren\t%1\n"
RLOCKSHM22 "\tEinzelsatzsperren\t\t%1\n"
RLOCKSHM24 "Diese Daten kˆnnen mit Hilfe folgender konfigurierbarer"
RLOCKSHM25 "Parameternamen ge‰ndert werden:\n"
RLOCKSHM27 "\t%1 - %2\n"
RLOCKSHM28 "\nWeitere vorhandene Speicherinformationen:\n\n"
RLOCKSHM29 "\tTabelleneintr‰ge f¸r geˆffnete Dateien\t\t%1 @ %2 Byte\n"
RLOCKSHM30 "\tTabelleneintr‰ge f¸r Datei-Header\t%1 @ %2 Byte\n"
RLOCKSHM31 "\tTabelleneintr‰ge f¸r Hash-Datei\t%1 @ %2 Byte\n"
RLOCKSHM32 "\tTabelleneintr‰ge f¸r Datensatzsperre\t%1 @ %2 Byte\n"
RLOCKSHM34 "\tGeˆffnete Segmentbasis\t\t%1\n"
RLOCKSHM35 "\tDateisegmentbasis\t\t%1\n"
RLOCKSHM36 "\tSperrsegmentbasis\t\t%1\n"
RLOCKSHM38 "\tgeˆffnete Dateitabelle\t\t\t%1\n"
RLOCKSHM39 "\tDatei-Header-Tabelle\t\t%1\n"
RLOCKSHM40 "\tHash-Dateitabelle\t\t%1\n"
RLOCKSHM41 "\tDatensatz-Sperrtabelle\t\t%1\n"
RLOCKSHM43 "\tFreiliste der Tabelle der geˆffneten Dateien \t\t%1\n"
RLOCKSHM44 "\tFreiliste der Dateitabelle\t\t%1\n"
RLOCKSHM45 "\tFreiliste der Sperrsatztabelle\t\t%1\n"
RLOCKSHM46 "\tTabelleneintr‰ge f¸r geˆffnete Dateien\t\t%1 @ %2 Byte\n"
RLOCKSHM47 "\tTabelleneintr‰ge f¸r Datei-Header\t%1 @ %2 Byte\n"
RLOCKSHM48 "\tTabelleneintr‰ge f¸r Hash-Datei\t%1 @ %2 Byte\n"
RLOCKSHM49 "\tTabelleneintr‰ge f¸r Datensatzsperre\t%1 @ %2 Byte\n"
RLOCKSHM50 "\tgesamte Segmentgrˆﬂe\t\t%1 Byte\n"
RLOCKSHM52 "\tEinzelsatzsperren\t\t%1\n"
RLOCKSHM54 "\tAnschluﬂbasis\t\t\t%1"
RLOCKSHM55 " (Programm ausgew‰hlt)"
RLOCKSHM57 "\tgeˆffnete Dateitabelle\t\t\t%1\n"
...
RLOCKSHM65 "\tbenˆtigter Faktor f¸r die Anpassung\t%1\n"
RLOCKSHM66 "\nEintr‰ge der Datei-Headertabelle:\n"
RLOCKSHM100 "Eintrag"
...
RLOCKSHM70 "\nTabelleneintr‰ge f¸r Hash-Datei-Header:\n"
RLOCKSHM200 "Eintrag"
RLOCKSHM201 "Datei-Header"
RLOCKSHM75 "\nTabelleneintr‰ge f¸r Datensatzsperre:\n"
RLOCKSHM111 "N‰chste_Sperre"
RLOCKSHM112 "Niederwertige_Sperre"
RLOCKSHM113 "Hochwertige_Sperre"
RLOCKSHM114 "Sitzungs-ID"
RLOCKSHM115 "DOS_PID"
RLOCKSHM116 "N‰chster_Index"
RLOCKSHM80 "\nTabelleneintr‰ge der geˆffneten Dateien:\n"
RLOCKSHM120 "N‰chste_geˆffnete_Datei"
RLOCKSHM121 "Header"
...
$quote "
SET_CFG1 "Unzul‰ssige Konfigurations-Zeichenkette: '%1'\n"
SET_CFG2 "Kein Name f¸r '%1' geliefert.\n"
SET_CFG3 "Der Name in '%1' ist zu lang.\n"
SET_CFG4 "Keine Daten f¸r '%1' geliefert.\n"
SET_CFG5 "Unbekannter Name: '%1'\n"
SET_CFG6 "Die Daten f¸r '%1' d¸rfen nicht negativ sein.\n"
SET_CFG7 "Die Daten f¸r '%1' sind ung¸ltig.\n"
SET_CFG8 "Daten f¸r '%1' m¸ssen weniger als %2 sein.\n"

$ The following are handcrafted from set_cfg.c
SET_CFG100 "Basis"
SET_CFG101 "Segmentanschluﬂ-Adresse (0 = Programm ausgew‰hlt)"
SET_CFG102 "Schl¸ssel"
SET_CFG103 "LSW f¸r gemeinsam genutzten Speicher und Sperrsatzschl¸ssel festlegen"
SET_CFG104 "offene_Tabelle"
SET_CFG105 "Max. Anzahl an Tabelleneintr‰gen f¸r geˆffnete Dateien"
SET_CFG106 "Dateitabelle"
SET_CFG107 "Max. Anzahl an Tabelleneintr‰gen f¸r Datei-Header"
SET_CFG108 "Hash-Tabelle"
SET_CFG109 "Max. Anzahl an Tabelleneintr‰gen f¸r Hash-Datei"
SET_CFG110 "Sperrtabelle"
SET_CFG111 "Max. Anzahl an Tabelleneintr‰gen f¸r Datensatzsperre"
SET_CFG112 "Datensatzsperren"
SET_CFG113 "Max. Anzahl an Sperren f¸r jeden Datensatz"
...
LICM_BAD_KEY	"Ung¸ltige Lizenz (fehlerhafter Lizenzschl¸ssel)\n"
LICM_ALTERED	"Ung¸ltige Lizenz (ver‰nderter Text)\n"
LICM_NO_ID	"Ung¸ltige Lizenz (keine Lizenz-ID)\n"
...
LICM_BAD_SERIAL	"Ung¸ltige Client-Seriennummer angegeben\n"

LICU_DUPLICATE	"Doppelte Client-Seriennummer angegeben, Verbindung nicht erlaubt."
LICU_INVALID	"Ung¸ltige Client-Seriennummer, Verbindung nicht erlaubt."
LICU_RESOURCE	"Host-Ressource ist nicht verf¸gbar, setzen Sie sich mit Ihrem Systemverwalter in Verbindung."

$ %1 is the maximum number of clients
LICU_LIMIT	"Dieser Server hat sein per Lizenz festgelegtes Client-Limit (%1) erreicht, keine Verbindung mˆglich."

$ %1 is the log file name, %2 is the error string, %3 and %4 (where used) are
$ the user and group IDs, respectively
LOG_OPEN	"Protokolldatei '%1' kann nicht geˆffnet werden, %2\n"
LOG_CHMODE	"Modus von '%1' kann nicht ge‰ndert werden, %2\n"
LOG_CHOWN	"Eigent¸mer von '%1' kann nicht auf %3/%4 ge‰ndert werden, %2\n"
LOG_REOPEN	"Nach Abschneidung kann '%1' nicht wieder geˆffnet werden, %2\n"

$ %1 is a host file descriptor
LOG_OPEND	"Protokoll von Beschreiber %1 kann nicht erneut geˆffnet werden\n"
...
MEM_NONE	"%1 Byte Speicherplatz kˆnnen nicht zugeordnet werden.\n"
MEM_RESIZE	"Speichergrˆﬂe kann nicht auf %1 Byte ver‰ndert werden\n"

$ %1 is the host name
NETAD_NOHOST	"Kann Daten ¸ber Host '%1' nicht finden\n"

$ %1 is the error string
NETIF_DEVACC	"Kann nicht auf das Netzwerkger‰t zugreifen, %1\n"
...
NETIO_CORRUPT	"Interne Netzwerktabelle wurde besch‰digt\n"
NETIO_MUXERR	"Netzwerk-Multiplexing-Fehler\n"

$ %1 is the size of a network packet
NETIO_PACKET	"Die maximale Netzwerk-Paketgrˆﬂe (%1) ist zu klein\n"
...
DOSSVR_SETIF	"Kann die lokale Netzwerkschnittstelle nicht ˆffnen\n"
DOSSVR_CURDIR	"Kann das gegenw‰rtige Arbeitsverzeichnis nicht bestimmen\n"
...
DOSSVR_G_TERMA	"Kann Zeilenattribute f¸r Terminal nicht bekommen, %1\n"
DOSSVR_S_TERMA	"Kann Zeilenattribute f¸r Terminal nicht festlegen, %1\n"
DOSSVR_C_CPIPE	"Kann Konfigurations-Pipe nicht erstellen, %1\n"
DOSSVR_NOFORK	"Kann neuen Prozeﬂ nicht erstellen, %1\n"
...
CONSVR_NOMEM	"Kann Speicher f¸r die Funktionszeichenkette nicht zuordnen\n"
CONSVR_NO_NET	"Kann die Netzwerkschnittstelle(n) nicht ˆffnen\n"
...
VFILE_NOMEM	"Kann f¸r %1 Objekte keinen Speicher zuordnen, jeweils %2 Byte\n"
...
DEBUG_CHILD	"untergeordneter Prozeﬂ"
DEBUG_OFF	"aus"
DEBUG_ON	"ein"

$ %1 is the program name
DEBUG_USAGE	"Befehlsformat: %1 <PID> [[op]Kan‰le] [untergeordneter_Prozeﬂ] [on] [off]\n"

$ %1 is the program name, %2 is the faulty command line argument
DEBUG_ARG	"%1: Ung¸ltiges Argument: '%2'\n"
...
DEBUG_INVAL	"%1: Prozeﬂ %2 kann nicht signalisiert werden, %3\n"
DEBUG_NO_SIG	"%1: Kann Prozeﬂ %2 nicht signalisieren, %3\n"

$ %1 is the program name, %2 is a channel number specified in the argument list
DEBUG_BADBIT	"%1: Kanal-Nr.%2 ist auﬂerhalb des Bereichs\n"
...
CONVERT1 "Klein- und Groﬂschreibung sind BEIDE angegeben\n"
CONVERT1A "Nicht kompatible Optionen angegeben\n"
CONVERT2 "In Konflikt stehende ‹bersetzungen angegeben\n"
...
CONVERT4 "÷ffnen von %1 nicht mˆglich\n"
...
CONVERT8 "Groﬂ-/Kleinschreibung ohne ‹bersetzung angegeben\n"

$ translation table %1 cannot be opened
CONVERT10 "÷ffnen der ‹bersetzungstabelle %1 nicht mˆglich\n"
...
CONVERT90 "Zuordnung weiteren Speicherplatzes nicht mˆglich!\n"
...
CONVERT_M3_D "Optionen sind: /u      Datei Groﬂschreibung\n\
...
\n"
CONVERT_M5_D "\                /c c    c als user_char des ‹bersetzungsfehlers verwenden.\n\
\                /m      Mehrfache Zeichen¸bersetzungen erlauben.\n\
\                /a      Abbruch beim ‹bersetzungsfehler.\n\
\                /s      Die beste einfache Zeichen¸bersetzung verwenden.\n\
\                /z      STRG-Z ordnungsgem‰ﬂ handhaben.\n\
\n"
...
CONVERT_M3_U "Optionen sind: -u      Datei Groﬂschreibung\n\
\                -l      Datei Kleinschreibung\n\
\                -f      Gezwungen (alte Option)\n\
\                -b      Bin‰r (alte Option)\n"
...
\                -o tbl  Ausgabetabelle tbl ¸bersetzen.\n\
\n"
CONVERT_M5_U "\                /c c    c als user_char des ‹bersetzungsfehlers verwenden.\n\
\                /m      Mehrfache Zeichen¸bersetzungen erlauben.\n\
\                /a      Abbruch beim ‹bersetzungsfehler.\n\
\                /s      Die beste einfache Zeichen¸bersetzung verwenden.\n\
\                /z      STRG-Z ordnungsgem‰ﬂ handhaben.\n\
