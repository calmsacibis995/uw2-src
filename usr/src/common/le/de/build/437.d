...
$ failed translation
ON34 "%1: öbersetzungsfehler %2.\n"

ON35 "LMF-Datei Datei \"ABORT_CHECK\" falsch angegeben\n"
ON36 "TemporÑre Datei %1 kann nicht angelegt werden\n"
...
ERRVEC2		"HostausfÅhrung fehlgeschlagen."
ERRVEC3		"UngÅltiges Format."
...
PCICONF18 "ZURöCKGEBEN\n"
PCICONF19 "Fehler: UngÅltige Aktion: %1\n"
...
PCIINIT1 "Richtiges BRIDGE-GerÑt nicht gefunden\n"
...
PCIINIT_FOR_NET   "Zur Verwendung Åber Netzwerkschnittstelle\n"
PCIINIT_FOR_RS232 "Zur Verwendung Åber RS232-Ports\n"
PCIINIT_FOR_BOTH  "Zur Verwendung Åber Netzwerkschnittstelle und RS232-Ports\n"
...
PCIINIT6 "UngÅltige Rundspruchadresse <%1>\n"
...
PCIINIT8 "UngÅltige lokale Adresse <%1>\n"
...
PCIINIT10 "\"HOSTS\" und \"EXCELAN\\tcp\" mÅssen Åbereinstimmen\n"

PCIINIT11 "ôffnen von %1 unmîglich\n"
PCIINIT12 "Bridge-Version mu· grî·er als 2.7.2 sein\n"

$ The next two messages refer to the HOSTS file
PCIINIT13 "ôffnen von Datei %1 nicht mîglich.\n"
PCIINIT14 "%1 ist defekt oder ungÅltig.\n"
...
PCIINIT ohne Option /e ausfÅhren, um PC-I zu initialisieren.\n"

$ The subnet mask is not in the proper format 
PCIINIT27 "UngÅltige Subnetmask<%1>\n"

$ The subnet mask is not in the proper format 
PCIINIT28 "UngÅltige Subnetmask<%1.%2.%3.%4>\n"

$ Netware is already installed
PCIINIT30 "Initialisierung nach Initialisierung von Netware nicht mîglich\n"
...
JOBS_MSG " AuftragstabelleneintrÑge\r\n\$"
...
PRINTER1 "Drucker: Einstellung des Zustands nicht mîglich.\n"

$ the printer name given is not in the range allowed or is non-numeric
PRINTER2 "%1: Falscher Name fÅr Druckdatenstrom.\n"

$ This message says that you can't reset the printer program
$ when you are just setting it
PRINTER3 "Beim Einstellen des Druckerprogramms ist %1 ungÅltig\n"
...
PRINTER7 "printer [LPTn] {Host|Laufwerk|-} [Druckprogramm|/R] [/X[0|1]]\n        [/T[ZeitÅberschreitung]]\n"
$ %1 is the 'remote' token, for Merge is "unix" (or "aix", on an AIX machine).
PRINTER7_M "printer [LPTn] %1 [Druckprogramm|/R] [/X[0|1]] [/T[ZeitÅberschreitung]]\n"
PRINTER8 "printer [LPTn] [/P|/D] [/X[0|1]] [/T[ZeitÅberschreitung]]\n"
...
PRINTER11 "Einstellung der Druckerparamter (LPT%1) nicht mîglich\n"
PRINTER12 "Einstellung des fernen LPT%1 nicht mîglich.  Wahrscheinlich sind Sie nicht angemeldet.\n"
PRINTER13 "Ihre Bridge-Version unterstÅtzt nur LPT1.\n"
PRINTER14 "Drucker: Einstellung des Zustands nicht mîglich.\n"
PRINTER15 "Drucker: Status nicht erhalten.\n"
PRINTER16 "Die Option %1 wird von Ihrer Bridge-Version nicht unterstÅtzt\n"
PRINTER22 "LPT%1: "
...
PRINTER26 "ein"
PRINTER27 "aus"
PRINTER28 ", ZeitÅberschreitung = %1"
PRINTER29 ", keine ZeitÅberschreitung"
PRINTER30 ",\n      "
PRINTER31 ", "
PRINTER32 "\"%1\"\n"
...
PRINTER35 " mit  %1 zweiter ZeitÅberschreitung."
PRINTER36 " ohne ZeitÅberschreitung."
...
$ %1 is drive number
UDIR1 " DatentrÑger in Laufwerk %1 "
...
UDIR17 "UngÅltige Laufwerksbezeichnung\n"
...
DOSWHAT5 "%1: \n\tVerzeichnis\n"
DOSWHAT7 "%1:\n\tGerÑt\n"
DOSWHAT8 "%1: ôffnen von %2 nicht mîglich\n"
DOSWHAT9 "%1: fstat bei %2 nicht mîglich\n"
DOSWHAT11 "%1:\n\tGerÑt\n"

DOSWHAT14 "Dateityp nicht festgelegt: Versuchen Sie es mit dem UNIX-Dateibefehl.\n"

DOSTYPE0 " BinÑre Datei\n"
...
PCIDEBUG2 "%1: UngÅltiges Argument: \"%2\"\n"
...
BADDRIVE "UngÅltige Laufwerksangabe - %1\n"
USEAGEBADDRIVE "UngÅltige Laufwerksangabe - %1\n"
...
\n"
CONVERT_M5_D "\                /c c    c als Benutzerzeichen fÅr fehlgeschlagene öbersetzung verwenden.\n\
\                /m      MehrfachzeichenÅbersetzungen verwenden.\n\
\                /a      Bei fehlgeschlagener öbersetzung abbrechen.\n\
\                /s      Beste EinzelzeichenÅbersetzung verwenden.\n\
...
\                -o tbl  Ausgabetabelle tbl Åbersetzen.\n\
\n"
CONVERT_M5_U "\                -c c    c als Benutzerzeichen fÅr fehlgeschlagene öbersetzung verwenden.\n\
\                -m      MehrfachzeichenÅbersetzungen verwenden.\n\
\                -a      Bei fehlgeschlagener öbersetzung abbrechen.\n\
\                -s      Beste EinzelzeichenÅbersetzung verwenden.\n\
\                -z      C-Z richtig handhaben (dos2unix/unix2dos).\n\
...
HOSTOPTN1 "UngÅltige Host-Auswahloption(en)"
