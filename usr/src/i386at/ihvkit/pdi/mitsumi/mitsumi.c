...
#ident	"@(#)ihvkit:pdi/mitsumi/mitsumi.c	1.1"
#ident	"$Header: $"
 ...
 *	MITSUMI.C
 *
 *	MITSUMI CRMC-LU005S Version 0.00
 *
 ******************************************************************************
 *****************************************************************************/
...
static int	mod_dynamic = 0;		/* 1 if was a dynamic load */
...
char		mitsumi_diskprod[ 16 ] = "CRMC-LU005S";
...
static	int	mitsumidevflag = HBA_MP;
...
mitsumistart( void )
{
	...
	for ( i = 0; i < mitsumi_cntls; i++ ) {
		...
		found ++;
		cmn_err(CE_NOTE, "!MITSUMI CRMC-LU005S CDROM version %d was found", 
			mitsumi_drive_ver);
	}
