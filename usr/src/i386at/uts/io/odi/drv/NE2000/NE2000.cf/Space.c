...
#ident	"@(#)kern-i386at:io/odi/drv/NE2000/NE2000.cf/Space.c	1.4"
#ident	"$Header: $"
 ...
 */
int			NE2000_nmulticast = 8;

/*
 * the major numbers for the devices.
 */
int			NE2000_cmajor_0 = NE2000_CMAJOR_0;
int			NE2000_cmajor_1 = NE2000_CMAJOR_1;
int			NE2000_cmajor_2 = NE2000_CMAJOR_2;
int			NE2000_cmajor_3 = NE2000_CMAJOR_3;

/*
 * special flags required for special setup. see definitions in lsl.h.
 */
int			NE2000_setupflag = 0;
 ...
 * installed.
 */
#define	IFNAME		"NE2000"
char			*NE2000_ifname = IFNAME;

char			*NE2000_id_string =
				"Novell NE2000" " " "Version 3.27 Revision 0 11/3/1993";
char			*NE2000_copyright = "Copyright 1993 Novell, Inc.  All rights reserved.";

/*
 * the driver topology type. eg: TSM_T_ETHER for ethernet, TSM_T_TOKEN for
 * token ring.
 */
int			NE2000_tsm_type   = TSM_T_ETHER;
