...
#ident	"@(#)kern-i386at:io/odi/drv/IBMEST/IBMEST.cf/Space.c	1.3"
#ident	"$Header: $"
 ...
 */
int			IBMEST_nmulticast = 8;

/*
 * the major numbers for the devices.
 */
int			IBMEST_cmajor_0 = IBMEST_CMAJOR_0;
int			IBMEST_cmajor_1 = IBMEST_CMAJOR_1;
int			IBMEST_cmajor_2 = IBMEST_CMAJOR_2;
int			IBMEST_cmajor_3 = IBMEST_CMAJOR_3;

/*
 * special flags required for special setup. see definitions in lsl.h.
 */
int			IBMEST_setupflag = 0;
