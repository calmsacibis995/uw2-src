...
#ident	"@(#)kern-i386at:io/odi/drv/TCTOKH/TCTOKH.cf/Space.c	1.3"
#ident	"$Header: $"
 ...
 */
int			TCTOKH_nmulticast = 8;

/*
 * the major numbers for the devices.
 */
int			TCTOKH_cmajor_0 = TCTOKH_CMAJOR_0;
int			TCTOKH_cmajor_1 = TCTOKH_CMAJOR_1;
int			TCTOKH_cmajor_2 = TCTOKH_CMAJOR_2;
int			TCTOKH_cmajor_3 = TCTOKH_CMAJOR_3;

/*
 * special flags required for special setup. see definitions in lsl.h.
 */
int			TCTOKH_setupflag = 0;
 ...
 * installed.
 */
#define	IFNAME		"TCTOKH"
char			*TCTOKH_ifname = IFNAME;

char			*TCTOKH_id_string =
				"Thomas-Conrad Token Ring" " " "Version 1.20 Revision 0 4/26/1994";
char			*TCTOKH_copyright = "(C) Copyright 1994, Thomas-Conrad Corp.  All rights reserved.";

/*
 * the driver topology type. eg: TSM_T_ETHER for ethernet, TSM_T_TOKEN for
 * token ring.
 */
int			TCTOKH_tsm_type   = TSM_T_TOKEN;
