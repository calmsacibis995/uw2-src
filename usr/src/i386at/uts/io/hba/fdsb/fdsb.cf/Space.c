...
#ident	"@(#)kern-i386at:io/hba/fdsb/fdsb.cf/Space.c	1.2"
/*
...
#ifdef  FDSB_CPUBIND
    #define FDSB_VER        (HBA_SVR4_2MP | HBA_IDATA_EXT)
    struct  hba_ext_info    fdsb_extinfo = {
        0, FDSB_CPUBIND
    };
#else
    #define FDSB_VER        HBA_SVR4_2MP
#endif

struct  hba_idata_v4    _fdsb_idata[] = {
