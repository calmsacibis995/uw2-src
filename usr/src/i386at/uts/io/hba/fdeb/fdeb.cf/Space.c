...
#ident	"@(#)kern-i386at:io/hba/fdeb/fdeb.cf/Space.c	1.2"
/*
...
struct fdc_idev fds_table[] =
{
    ...
    {"ARCHIVE Python 25588                ", 20,      0, 512,   0},
    {"WANGTEK 5525ES                      ", 14,      0, 512,   0},
    {"NEC     CD-ROM                      ", 14,      0,   0,   1},
...
#ifdef  FDEB_CPUBIND
    #define FDEB_VER        (HBA_SVR4_2MP | HBA_IDATA_EXT)
    struct  hba_ext_info    fdeb_extinfo = {
        0, FDEB_CPUBIND
    };
#else
    #define FDEB_VER        HBA_SVR4_2MP
#endif

struct  hba_idata_v4    _fdeb_idata[] = {
    { 1, "(fdeb,1) Future Domain SCSI", 7, 0, -1, 0, -1, 0 }
#ifdef FDEB_CPUBIND
    ,
