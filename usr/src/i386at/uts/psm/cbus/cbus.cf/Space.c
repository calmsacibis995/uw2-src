...
#ident	"@(#)kern-i386at:psm/cbus/cbus.cf/Space.c	1.1"
#ident	"$Header: $"
...
int corollary_nmi_debug();
int (*corollary_nmi_hook)() = corollary_nmi_debug;

#ifdef NEVER
void (*corollary_nmi_hook)();
#endif

void (*corollary_main_hook)();
...
pl_t svcpri[IDTSZ];	/* service priority level for each interrupt */
